module.exports = function(grunt) {
    grunt.registerTask('build-slds-public-assets', 'Crawls the slds assets files and copies them into the proper place in public/assets/design-system.', function() {
        var
            output = '# SLDS Assets Copied to Public \n\n',
            generatedFileName = '/slds-public-assets-files-copied.md'
        ;
        output += '## Manifest\n';
        output += 'List of files that exists copied from:\n\n';
        output += '`' + __PATHS__.slds_assets + '`\n\n';
        output += '...into:\n\n';
        output += '`' + __PATHS__.slds_public_assets + '`\n\n';
        ...
        var newfiles = files.map(function(file) {
            ...
            var destinationFilePath = __PATHS__.slds_public_assets + file.substring((__PATHS__.slds_assets.length))
