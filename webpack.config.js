...
config.resolve.alias['design-system-utilities'] = path.join(__dirname, 'node_modules/slds-for-js-core/utilities/main.js');
config.resolve.alias['utilities'] = path.join(__dirname, 'node_modules/slds-for-js-core/utilities/main.js');
config.resolve.alias['design-system-utilities-react'] = path.join(__dirname, 'node_modules/slds-for-js-core/utilities/main.js');
