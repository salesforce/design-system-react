	...
	render () {		
		return (
			<div className="actions">
				...
				<button type="button" className="btn btn-default btn-next" onClick={this.props.onNextClicked}>{this.props.isLast ? this.props.strings.COMPLETE : this.props.strings.NEXT}<span className="glyphicon glyphicon-arrow-right"></span></button>
			</div>
		);
	}
});
