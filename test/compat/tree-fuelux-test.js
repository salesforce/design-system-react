/*
 * TREE - FUELUX JQUERY - API TESTS
 */

import { CONTROL as controlName } from '../../src/core/tree';   // <-- change this one line and then copy past below.
...
describe('Fuel UX ' + controlName, function () {
	before(function () {
			...
			callback({
				data: [
					...
					},
					{
						...
						attr: {
							id: 'item1', 'data-icon': 'glyphicon glyphicon-file'
						}
					},
					{
						name: 'Drawing Hands', type: 'folder',
						attr: {
							id: 'folder2', 'data-children': false
						}
					},
					{
					...
					},
					{
						...
						attr: {
							id: 'item3', 'data-icon': 'glyphicon glyphicon-picture'
						}
					},
					{
		...
		textDataSource = function (options, callback) {
			callback({
				data: [
					{
						text: 'node text', type: 'folder',
						attr: {
							id: 'folder1'
						}
					}
