...
storiesOf(GLOBAL_NAVIGATION_BAR, module)
	...
	.add('Custom Cloud (Overview active and white)', () => getGlobalNavigationBarCustomCloudOverviewAcive(propSets.customCloud.props, propSets.customCloud.primaryRegionProps))
