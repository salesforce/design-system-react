...
if (process.env.NODE_ENV !== 'production') {
  ...
  isTriggerTabbable = function isTriggerTabbable(COMPONENT, trigger, comment) {
    ...
    trigger.type.displayName !== _constants.BUTTON && trigger.type.displayName !== _constants.BUTTON_STATEFUL && trigger.type.displayName !== _constants.BUTTON_GROUP && trigger.type.displayName !== _constants.CHECKBOX && trigger.type.displayName !== _constants.DATE_PICKER && trigger.type.displayName !== _constants.INPUT && trigger.type.displayName !== _constants.LOOKUP && trigger.type.displayName !== _constants.TIME_PICKER) {
      ...
      if (childTabIndex === '-1' || childTabIndex === undefined) {
        ...
        if (!hasWarned[COMPONENT]) {
          ...
          (0, _warning2.default)(elementIsTabbable, "[Design System React] The element that triggers ".concat(COMPONENT, " must be tabbable for keyboard users. Elements such as anchor, button, input or a DOM element with tabIndex=\"0\" specified are tabbable. ").concat(additionalComment));
