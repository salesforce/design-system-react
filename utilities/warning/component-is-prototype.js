...
if (process.env.NODE_ENV !== 'production') {
  ...
  isPrototype = function isPrototype(control, comment) {
    ...
    if (!hasWarned[control]) {
      ...
      (0, _lowPriorityWarning2.default)(false, "[Design System React] ".concat(control, " is a prototype. (a) Props may change within a minor release. (b) Web Content Accessibility Guidelines may not be met. (c) CSS imports may be required, since it is being added to SLDS.").concat(additionalComment));
