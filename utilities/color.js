  ...
  getNewColor: function getNewColor(options, customHexValidator) {
    ...
    if (options.hex) {
      if (customHexValidator ? !customHexValidator(options.hex) : !this.isValidHex(options.hex)) {
        return (0, _lodash2.default)({}, oldColor, {
          hex: options.hex,
          errors: (0, _lodash2.default)({}, oldColor && oldColor.errors, {
            hex: true
          }),
          hsv: {
            hue: '',
    ...
    if ('red' in options || 'blue' in options || 'green' in options) {
      var rgb = (0, _lodash2.default)({}, oldColor.rgb, options);
      var errors = this.getRgbErrors(rgb);

      if (Object.values(errors).includes(true)) {
        return (0, _lodash2.default)({}, oldColor, {
          rgb: rgb,
          errors: (0, _lodash2.default)({}, oldColor && oldColor.errors, errors)
        });
      }
    ...
    if ('hue' in options || 'saturation' in options || 'value' in options) {
      var hsv = (0, _lodash2.default)({}, oldColor.hsv, options);
      return {
