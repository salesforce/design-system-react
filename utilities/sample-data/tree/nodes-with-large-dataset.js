...
export default {
	...
	nodes: [
		{
			nodes: [
				{ id: 4001, label: 'bunriw', type: 'item', _isExpandable: false },
			],
			id: 4002,
			label: 'gakhu',
			type: 'branch',
		...
		},
		{
			nodes: [
				{
					nodes: [
						{ id: 4031, label: 'gap', type: 'item', _isExpandable: false },
					],
					id: 4032,
					label: 'hinow',
					type: 'branch',
		...
		{
			nodes: [
				{ id: 4059, label: 'tuel', type: 'item', _isExpandable: false },
				{
					nodes: [
						{ id: 4056, label: 'son', type: 'item', _isExpandable: false },
					],
					id: 4057,
					label: 'dumla',
					type: 'branch',
		...
		{
			nodes: [
				{ id: 4088, label: 'ocibeb', type: 'item', _isExpandable: false },
			],
			id: 4089,
			label: 'vufeesi',
			type: 'branch',
		...
		{
			nodes: [
				{ id: 4090, label: 'mulcav', type: 'item', _isExpandable: false },
			],
			id: 4091,
			label: 'ukizi',
			type: 'branch',
		...
		{
			nodes: [
				{ id: 4100, label: 'fiuru', type: 'item', _isExpandable: false },
				{
					nodes: [
						{ id: 4097, label: 'ti', type: 'item', _isExpandable: false },
					],
					id: 4098,
					label: 'ka',
					type: 'branch',
		...
		},
		{
			nodes: [
				{
					nodes: [
						{ id: 4122, label: 'ak', type: 'item', _isExpandable: false },
					],
					id: 4123,
					label: 'wugmugzes',
					type: 'branch',
		...
		{
			nodes: [
				{ id: 4128, label: 'reziak', type: 'item', _isExpandable: false },
			],
			id: 4129,
			label: 'abucu',
			type: 'branch',
		...
		{
			nodes: [
				{ id: 4140, label: 'fakefup', type: 'item', _isExpandable: false },
				{
					nodes: [
						{
							id: 4137,
		...
		{
			nodes: [
				{ id: 4173, label: 'seifju', type: 'item', _isExpandable: false },
			],
			id: 4174,
			label: 'lefef',
			type: 'branch',
		...
		{
			nodes: [
				{ id: 4185, label: 'ti', type: 'item', _isExpandable: false },
				{
					nodes: [
		...
		{
			nodes: [
				{ id: 4190, label: 'geri', type: 'item', _isExpandable: false },
				{
					nodes: [
						{ id: 4187, label: 'rus', type: 'item', _isExpandable: false },
					],
					id: 4188,
					label: 'bali',
					type: 'branch',
		...
		{
			nodes: [
				{ id: 4205, label: 'ic', type: 'item', _isExpandable: false },
				{
					nodes: [
		...
		{
			nodes: [
				{ id: 4213, label: 'piusta', type: 'item', _isExpandable: false },
			],
			id: 4214,
			label: 'nepone',
			type: 'branch',
		...
		{
			nodes: [
				{ id: 4221, label: 'nogeh', type: 'item', _isExpandable: false },
				{
					nodes: [
						{
							id: 4218,
		...
		},
		{
			nodes: [
				...
				{
					nodes: [
						{ id: 4255, label: 'ted', type: 'item', _isExpandable: false },
					],
					id: 4256,
					label: 'owu',
					type: 'branch',
		...
		{
			nodes: [
				{ id: 4264, label: 'macoceb', type: 'item', _isExpandable: false },
			],
			id: 4265,
			label: 'tup',
			type: 'branch',
		...
		{
			nodes: [
				{ id: 4266, label: 'liwzauv', type: 'item', _isExpandable: false },
			],
			id: 4267,
			label: 'aletja',
			type: 'branch',
		...
		},
		{
			nodes: [
				...
				{
					nodes: [
						{ id: 4274, label: 'in', type: 'item', _isExpandable: false },
					],
					id: 4275,
					label: 'tutothiv',
					type: 'branch',
		...
		{
			nodes: [
				{ id: 4292, label: 'gegeug', type: 'item', _isExpandable: false },
				{
					nodes: [
						{ id: 4289, label: 'vu', type: 'item', _isExpandable: false },
					],
					id: 4290,
					label: 'lavobe',
					type: 'branch',
		...
		},
		{
			nodes: [
				{
					nodes: [
						{ id: 4294, label: 'oz', type: 'item', _isExpandable: false },
					],
					id: 4295,
					label: 'hajfo',
					type: 'branch',
		...
		{
			nodes: [
				{ id: 4305, label: 'sopmal', type: 'item', _isExpandable: false },
			],
			id: 4306,
			label: 'miad',
			type: 'branch',
		...
		{
			nodes: [
				{ id: 4320, label: 'agocom', type: 'item', _isExpandable: false },
			],
			id: 4321,
			label: 'liz',
			type: 'branch',
		...
		{
			nodes: [
				{ id: 4327, label: 'ukrepiwa', type: 'item', _isExpandable: false },
				{
					nodes: [
						{ id: 4324, label: 'sib', type: 'item', _isExpandable: false },
					],
					id: 4325,
					label: 'vircothew',
					type: 'branch',
		...
		{
			nodes: [
				{ id: 4335, label: 'me', type: 'item', _isExpandable: false },
				{
					nodes: [
		...
		},
		{
			nodes: [
				{
					nodes: [
						{ id: 4337, label: 'ce', type: 'item', _isExpandable: false },
					],
					id: 4338,
					label: 'hogis',
					type: 'branch',
		...
		{
			nodes: [
				{ id: 4340, label: 'bufukil', type: 'item', _isExpandable: false },
			],
			id: 4341,
			label: 'pis',
			type: 'branch',
		...
		{
			nodes: [
				{ id: 4347, label: 'zozlof', type: 'item', _isExpandable: false },
				{
					nodes: [
						{ id: 4344, label: 'rub', type: 'item', _isExpandable: false },
					],
					id: 4345,
					label: 'selukic',
					type: 'branch',
		...
		{
			nodes: [
				{ id: 4355, label: 'ju', type: 'item', _isExpandable: false },
				{
					nodes: [
		...
		},
		{
			nodes: [
				...
				{
					nodes: [
						{ id: 4376, label: 'tar', type: 'item', _isExpandable: false },
					],
					id: 4377,
					label: 'kuta',
					type: 'branch',
		...
		{
			nodes: [
				{ id: 4418, label: 'lun', type: 'item', _isExpandable: false },
				{
					nodes: [
		...
		},
		{
			nodes: [
				{
					nodes: [
						{ id: 4427, label: 'su', type: 'item', _isExpandable: false },
					],
					id: 4428,
					label: 'regavapu',
					type: 'branch',
		...
		},
		{
			nodes: [
				{
					nodes: [
						{ id: 4430, label: 'usi', type: 'item', _isExpandable: false },
					],
					id: 4431,
					label: 'ukele',
					type: 'branch',
		...
		},
		{
			nodes: [
				{
					nodes: [
						{ id: 4461, label: 'la', type: 'item', _isExpandable: false },
					],
					id: 4462,
					label: 'lik',
					type: 'branch',
		...
		},
		{
			nodes: [
				{
					nodes: [
						{ id: 4475, label: 'vob', type: 'item', _isExpandable: false },
					],
					id: 4476,
					label: 'soaduma',
					type: 'branch',
		...
		},
		{
			nodes: [
				...
				{
					nodes: [
						{ id: 4535, label: 'sem', type: 'item', _isExpandable: false },
					],
					id: 4536,
					label: 'cefehgul',
					type: 'branch',
		...
		{
			nodes: [
				{ id: 4567, label: 'se', type: 'item', _isExpandable: false },
				{
					nodes: [
		...
		},
		{
			nodes: [
				{
					nodes: [
						{ id: 4629, label: 'maf', type: 'item', _isExpandable: false },
					],
					id: 4630,
					label: 'bolaz',
					type: 'branch',
		...
		{
			nodes: [
				{ id: 4663, label: 'ogegin', type: 'item', _isExpandable: false },
				{
					nodes: [
		...
		{
			nodes: [
				{ id: 4707, label: 'wafip', type: 'item', _isExpandable: false },
				{
					nodes: [
		...
		{
			nodes: [
				{ id: 4709, label: 'rehtel', type: 'item', _isExpandable: false },
			],
			id: 4710,
			label: 'pulmokut',
			type: 'branch',
		...
		},
		{
			nodes: [
				{
					nodes: [
						{ id: 4720, label: 'vob', type: 'item', _isExpandable: false },
					],
					id: 4721,
					label: 'ruzcaz',
					type: 'branch',
		...
		},
		{
			nodes: [
				{
					nodes: [
						{ id: 4725, label: 'vuz', type: 'item', _isExpandable: false },
					],
					id: 4726,
					label: 'ga',
					type: 'branch',
		...
		},
		{
			nodes: [
				{
					nodes: [
						{ id: 4731, label: 'izu', type: 'item', _isExpandable: false },
					],
					id: 4732,
					label: 'belcocusa',
					type: 'branch',
				...
				{
					nodes: [
						{ id: 4728, label: 'fof', type: 'item', _isExpandable: false },
					],
					id: 4729,
					label: 'bieg',
					type: 'branch',
		...
		{
			nodes: [
				{ id: 4772, label: 'vonmilu', type: 'item', _isExpandable: false },
				{
					nodes: [
		...
		{
			nodes: [
				{ id: 4784, label: 'jezoki', type: 'item', _isExpandable: false },
			],
			id: 4785,
			label: 'rad',
			type: 'branch',
		...
		},
		{
			nodes: [
				{
					nodes: [
						{ id: 4794, label: 'mu', type: 'item', _isExpandable: false },
					],
					id: 4795,
					label: 'roveswuz',
					type: 'branch',
		...
		{
			nodes: [
				{ id: 4842, label: 'pezzat', type: 'item', _isExpandable: false },
			],
			id: 4843,
			label: 'gioco',
			type: 'branch',
		...
		{
			nodes: [
				{ id: 4880, label: 'datuces', type: 'item', _isExpandable: false },
			],
			id: 4881,
			label: 'unfob',
			type: 'branch',
		...
		},
		{
			nodes: [
				{
					nodes: [
						{ id: 4919, label: 'ol', type: 'item', _isExpandable: false },
					],
					id: 4920,
					label: 'jun',
					type: 'branch',
		...
		{
			nodes: [
				{ id: 4922, label: 'guwkiku', type: 'item', _isExpandable: false },
			],
			id: 4923,
			label: 'molzofoti',
			type: 'branch',
		...
		{
			nodes: [
				{ id: 4924, label: 'zosumdi', type: 'item', _isExpandable: false },
			],
			id: 4925,
			label: 'kesel',
			type: 'branch',
		...
		{
			nodes: [
				{ id: 4945, label: 'tajevu', type: 'item', _isExpandable: false },
			],
			id: 4946,
			label: 'udhup',
			type: 'branch',
		...
		{
			nodes: [
				{ id: 4958, label: 'aniter', type: 'item', _isExpandable: false },
			],
			id: 4959,
			label: 'koleb',
			type: 'branch',
		...
		{
			nodes: [
				{ id: 4988, label: 'doizaic', type: 'item', _isExpandable: false },
			],
			id: 4989,
			label: 'mos',
			type: 'branch',
		...
		},
		{
			nodes: [
				{
					nodes: [
						{ id: 5034, label: 'hi', type: 'item', _isExpandable: false },
					],
					id: 5035,
					label: 'navpo',
					type: 'branch',
		...
		},
		{
			nodes: [
				{
					nodes: [
						{ id: 5045, label: 'di', type: 'item', _isExpandable: false },
					],
					id: 5046,
					label: 'isero',
					type: 'branch',
		...
		},
		{
			nodes: [
				{
					nodes: [
						{ id: 5107, label: 'tuj', type: 'item', _isExpandable: false },
					],
					id: 5108,
					label: 'gewkahfa',
					type: 'branch',
		...
		{
			nodes: [
				{ id: 5115, label: 'caopida', type: 'item', _isExpandable: false },
			],
			id: 5116,
			label: 'ruuf',
			type: 'branch',
		...
		{
			nodes: [
				{ id: 5120, label: 'mike', type: 'item', _isExpandable: false },
				{
					nodes: [
						{ id: 5117, label: 'ji', type: 'item', _isExpandable: false },
					],
					id: 5118,
					label: 'garpopel',
					type: 'branch',
		...
		},
		{
			nodes: [
				{
					nodes: [
						{ id: 5134, label: 'ifo', type: 'item', _isExpandable: false },
					],
					id: 5135,
					label: 'mopopnav',
					type: 'branch',
		...
		{
			nodes: [
				{ id: 5198, label: 'gostoube', type: 'item', _isExpandable: false },
				{
					nodes: [
						{ id: 5195, label: 'gev', type: 'item', _isExpandable: false },
					],
					id: 5196,
					label: 'wac',
					type: 'branch',
		...
		},
		{
			nodes: [
				{
					nodes: [
						{ id: 5203, label: 'von', type: 'item', _isExpandable: false },
					],
					id: 5204,
					label: 'zogsojan',
					type: 'branch',
				...
				{
					nodes: [
						{ id: 5200, label: 'dil', type: 'item', _isExpandable: false },
					],
					id: 5201,
					label: 'fompubze',
					type: 'branch',
		...
		{
			nodes: [
				{ id: 5216, label: 'ajkud', type: 'item', _isExpandable: false },
				{
					nodes: [
		...
		{
			nodes: [
				{ id: 5241, label: 'lugeiz', type: 'item', _isExpandable: false },
				{
					nodes: [
		...
		},
		{
			nodes: [
				{
					nodes: [
						{ id: 5280, label: 'ere', type: 'item', _isExpandable: false },
					],
					id: 5281,
					label: 'dinazi',
					type: 'branch',
		...
		{
			nodes: [
				{ id: 5306, label: 'ecvawa', type: 'item', _isExpandable: false },
				{
					nodes: [
						{ id: 5303, label: 'vi', type: 'item', _isExpandable: false },
					],
					id: 5304,
					label: 'af',
					type: 'branch',
		...
		{
			nodes: [
				{ id: 5336, label: 'gapos', type: 'item', _isExpandable: false },
				{
					nodes: [
