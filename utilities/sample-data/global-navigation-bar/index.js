  ...
  customCloud: {
    ...
    primaryRegionProps: {
      ...
      appLauncher: {
        ...
        id: 'app-launcher-trigger',
        noTruncate: true,
        triggerName: _react.default.createElement("div", {
          className: "slds-grid slds-grid_align-spread"
        }, _react.default.createElement("div", null, "Marketing Cloud"), _react.default.createElement("div", null, _react.default.createElement(_icon.default, {
          category: "utility",
