  ...
  customCloud: {
    ...
    primaryRegionProps: {
      ...
      appLauncher: {
        ...
        id: 'app-launcher-trigger',
        noTruncate: true,
        triggerName: _react2.default.createElement("div", {
          className: "slds-grid slds-grid--align-spread"
        }, _react2.default.createElement("div", null, "Marketing Cloud"), _react2.default.createElement("div", null, _react2.default.createElement(_icon2.default, {
          category: "utility",
