...
function (_React$Component) {
  ...
  _createClass(Example, [{
    ...
    value: function render() {
      var modal = this.state.noHeaderIsOpen ? _react.default.createElement(_modal.default, {
        assistiveText: {
