...
function (_React$Component) {
  ...
  _createClass(Modal, [{
    ...
    value: function dismissModalOnClickOutside() {
      ...
      var dismissOnClickOutside = this.props.dismissOnClickOutside ? this.props.dismissOnClickOutside : !this.props.disableClose;
    ...
    value: function headerComponent() {
      ...
      if (!headerContent && this.props.title || this.props.tagline) {
        headerContent = _react.default.createElement("div", null, this.props.toast, _react.default.createElement("h2", {
          ...
          id: this.getId()
        }, this.props.title), this.props.tagline ? _react.default.createElement("p", {
