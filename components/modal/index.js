define(['exports', 'react', 'prop-types', 'react-dom', '../button', 'classnames', 'react-modal', 'lodash.isboolean', 'shortid'], function (exports, _react, _propTypes, _reactDom, _button, _classnames, _reactModal, _lodash, _shortid) {
	'use strict';
			...
			value: function footerComponent() {
				...
				if (hasFooter) {
					...
					footer = _react2.default.createElement(
						'footer',
						{ className: (0, _classnames2.default)(footerClass, this.props.footerClassNames), onClick: this.handleModalClick },
						this.props.footer
					);
				}
				return footer;
