define(['module', 'react', 'prop-types', 'react-dom', '../button', 'classnames', 'react-modal', 'lodash.isboolean', 'shortid'], function (module, _react, _propTypes, _reactDom, _button, _classnames, _reactModal, _lodash, _shortid) {
	'use strict';
