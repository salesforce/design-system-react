...
var _checkAppElementSet = require("../../utilities/warning/check-app-element-set");

var _checkAppElementSet2 = _interopRequireDefault(_checkAppElementSet);
...
function (_React$Component) {
  ...
  _createClass(Modal, [{
    ...
    value: function componentWillMount() {
      ...
      (0, _checkProps2.default)(_constants.MODAL, this.props, _docs2.default);

      if (this.props.ariaHideApp) {
        (0, _checkAppElementSet2.default)();
      }
    }
  }, {
    ...
    value: function dismissModalOnClickOutside() {
      ...
      var dismissOnClickOutside = this.props.dismissOnClickOutside ? this.props.dismissOnClickOutside : this.props.dismissible;
