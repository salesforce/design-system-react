define(['exports', 'react', 'create-react-class', 'react-dom', 'react-modal', '../../button', '../../icon', '../../../utilities/event'], function (exports, _react, _createReactClass, _reactDom, _reactModal, _button, _icon, _event) {
	'use strict';
