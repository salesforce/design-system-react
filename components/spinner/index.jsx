...
const Spinner = (props) => {
	...
	const { containerClassName, containerStyle, id, isDelayed, isInput, size, variant } = props;
	const assistiveText =
	...
	return (
		<div className={classNames(containerClassName, 'slds-spinner_container')} style={containerStyle}>
			<div
				aria-hidden="false"
