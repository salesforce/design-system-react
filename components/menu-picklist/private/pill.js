define(['exports', 'react', 'prop-types', '../../../components/utilities/utility-icon', 'lodash.assign', 'airbnb-prop-types'], function (exports, _react, _propTypes, _utilityIcon, _lodash, _airbnbPropTypes) {
	'use strict';
