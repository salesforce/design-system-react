...
var MenuPicklist = (0, _createReactClass.default)({
  ...
  renderInlineMenu: function renderInlineMenu() {
    return !this.props.disabled && this.state.isOpen ? _react.default.createElement("div", {
  ...
  renderDialog: function renderDialog() {
    ...
    return !this.props.disabled && this.state.isOpen ? _react.default.createElement(_dialog.default, {
      closeOnTabKey: true,
  ...
  renderTrigger: function renderTrigger() {
    ...
    return (// eslint-disable-next-line jsx-a11y/no-static-element-interactions
      ...
      }, inputValue), _react.default.createElement(_icon.default, {
        name: "down",
        category: "utility"
  ...
  render: function render() {
    ...
    var requiredElem = required ? _react.default.createElement("span", {
      style: {
        color: 'red'
      }
    }, "* ") : null;
    ...
    }, requiredElem, label) : null, this.renderTrigger(), this.renderPills(), errorText && _react.default.createElement("div", {
      id: this.getErrorId(),
