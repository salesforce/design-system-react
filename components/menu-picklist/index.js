define(['module', 'react', 'prop-types', './check-props', 'classnames', 'shortid', '../utilities/dialog', '../icon', '../utilities/menu-list', '../utilities/menu-list/item-label', './private/pill', 'airbnb-prop-types', '../../utilities/keyboard-navigable-menu', '../../utilities/event', '../../utilities/key-code', '../../utilities/constants'], function (module, _react, _propTypes, _checkProps, _classnames, _shortid, _dialog, _icon, _menuList, _itemLabel, _pill, _airbnbPropTypes, _keyboardNavigableMenu, _event, _keyCode, _constants) {
	'use strict';
