define(['module', 'react', 'prop-types', './check-props', 'classnames', 'shortid', '../utilities/dialog', '../icon', '../utilities/menu-list', '../utilities/menu-list/item-label', './private/pill', 'airbnb-prop-types', '../../utilities/keyboard-navigable-menu', '../iconSettings', '../../utilities/event', '../../utilities/key-code', '../../utilities/constants'], function (module, _react, _propTypes, _checkProps, _classnames, _shortid, _dialog, _icon, _menuList, _itemLabel, _pill, _airbnbPropTypes, _keyboardNavigableMenu, _iconSettings, _event, _keyCode, _constants) {
	'use strict';
					...
					_react2.default.createElement(_pill2.default, {
						...
						events: {
							onRequestRemove: function onRequestRemove(event, data) {
								...
								newData.splice(_this.state.selectedIndices.indexOf(data.eventData.index), 1);
