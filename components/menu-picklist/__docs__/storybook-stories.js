define(['module', 'react', 'create-react-class', '@storybook/react', '../../icon-settings', '../../../utilities/constants', '../../menu-picklist'], function (module, _react, _createReactClass, _react3, _iconSettings, _constants, _menuPicklist) {
	'use strict';
	...
	var options = [{ label: 'An option that is Super Super Long', value: 'A0' }, { label: 'Another option', value: 'B0' }, { label: 'C Option', value: 'C0' }, { label: 'D Option', value: 'D0' }, { label: 'E Option', value: 'E0' }, { label: 'A1 Option', value: 'A1' }, { label: 'B2 Option', value: 'B1' }, { label: 'C2 Option', value: 'C1' }, { label: 'D2 Option', value: 'D1' }, { label: 'E2 Option Super Super Long', value: 'E1' }];

	var getPicklist = function getPicklist(props) {
		return _react2.default.createElement(
			'div',
			null,
			_react2.default.createElement(_menuPicklist2.default, props),
