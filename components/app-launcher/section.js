define(['module', 'react', 'prop-types', 'lodash.isfunction', 'classnames', '../button', '../../utilities/constants'], function (module, _react, _propTypes, _lodash, _classnames, _button, _constants) {
	'use strict';
