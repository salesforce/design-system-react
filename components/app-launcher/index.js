define(['exports', 'react', 'create-react-class', 'prop-types', 'classnames', 'lodash.isfunction', './check-props', '../modal', '../../utilities/constants'], function (exports, _react, _createReactClass, _propTypes, _classnames, _lodash, _checkProps, _modal, _constants) {
	'use strict';
