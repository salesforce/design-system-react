...
function (_React$Component) {
  ...
  function AppLauncher() {
    ...
    _this = _possibleConstructorReturn(this, (_getPrototypeOf2 = _getPrototypeOf(AppLauncher)).call.apply(_getPrototypeOf2, [this].concat(args)));
    ...
    _defineProperty(_assertThisInitialized(_this), "renderSearch", function () {
      ...
      if (_this.props.search) {
        returnVal = _react.default.createElement("div", {
  ...
  _createClass(AppLauncher, [{
    ...
    value: function componentWillMount() {
      ...
      (0, _checkProps.default)(_constants.APP_LAUNCHER, this.props, _docs.default);
    }
  }, {
    key: "render",
    value: function render() {
      ...
      var customModalHeader = _react.default.createElement("div", {
        className: "slds-grid slds-grid_align-spread slds-grid_vertical-align-center"
      }, _react.default.createElement("h2", {
        className: "slds-text-heading_medium"
      }, this.props.title), this.renderSearch(), this.props.modalHeaderButton ? this.props.modalHeaderButton : _react.default.createElement("span", {
      ...
      return _react.default.createElement("div", {
        ...
        className: "slds-r9"
      })), triggerAssistiveText && _react.default.createElement("span", {
        className: "slds-assistive-text"
      }, triggerAssistiveText))), _react.default.createElement(_modal.default, {
        ...
        containerClassName: (0, _classnames.default)('app-launcher', this.props.modalClassName),
        size: "large",
        header: customModalHeader,
        headerClassName: "slds-app-launcher__header"
      }, this.props.children), this.props.triggerName ? _react.default.createElement("span", {
        className: (0, _classnames.default)('slds-context-bar__label-action slds-context-bar__app-name', {
