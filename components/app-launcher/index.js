define(['module', 'react', 'prop-types', 'classnames', 'lodash.isfunction', './check-props', '../modal', '../../utilities/constants'], function (module, _react, _propTypes, _classnames, _lodash, _checkProps, _modal, _constants) {
	'use strict';
