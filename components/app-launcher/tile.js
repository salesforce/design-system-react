define(['exports', 'react', 'prop-types', 'classnames', '../utilities/truncate', 'lodash.isfunction', '../utilities/highlighter', '../popover-tooltip', '../../utilities/constants'], function (exports, _react, _propTypes, _classnames, _truncate, _lodash, _highlighter, _popoverTooltip, _constants) {
	'use strict';
