define(['exports', 'react', 'prop-types', 'lodash.isfunction', 'classnames', '../utilities/truncate', '../utilities/highlighter', '../popover-tooltip', '../../utilities/constants'], function (exports, _react, _propTypes, _lodash, _classnames, _truncate, _highlighter, _popoverTooltip, _constants) {
	'use strict';
