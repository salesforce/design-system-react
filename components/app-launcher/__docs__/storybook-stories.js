define(['module', 'react', 'create-react-class', 'prop-types', '@storybook/react', '../../../utilities/constants', '../../app-launcher', '../../app-launcher/tile', '../../app-launcher/section', '../../icon', '../../button', '../../forms/input/search', '../../global-navigation-bar', '../../global-navigation-bar/region', '../../icon-settings', '../../SLDSSettings'], function (module, _react, _createReactClass, _propTypes, _react3, _constants, _appLauncher, _tile, _section, _icon, _button, _search, _globalNavigationBar, _region, _iconSettings, _SLDSSettings) {
	'use strict';
	...
	var DemoAppLauncherTileWithIconNode = (0, _createReactClass2.default)({
		...
		render: function render() {
			var icon = _react2.default.createElement(_icon2.default, { name: 'campaign', category: 'standard', size: 'large' });
		...
		render: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					_section2.default,
					{ title: 'All Items', toggleable: true, onToggleClick: (0, _react3.action)('Section `All Items` open -->') },
				...
				_react2.default.createElement(
					_section2.default,
					{ title: 'All Apps', onToggleClick: (0, _react3.action)('Section `All App` open -->') },
					_react2.default.createElement(DemoAppLauncherTile, null),
					_react2.default.createElement(DemoAppLauncherTileWithIconNode, null)
				)
			);
	...
	var DemoAppLauncherSectionWithSmallTiles = (0, _createReactClass2.default)({
		...
		render: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					_section2.default,
					{ title: 'All Items', onToggleClick: (0, _react3.action)('Section `All Items` open -->') },
					_react2.default.createElement(DemoAppLauncherTile, null),
					_react2.default.createElement(DemoAppLauncherTileWithIconText, null),
					_react2.default.createElement(DemoAppLauncherTileWithIconNode, null)
				),
				_react2.default.createElement(
					_section2.default,
					{ title: 'All Apps', onToggleClick: (0, _react3.action)('Section `All App` open -->') },
					_react2.default.createElement(DemoAppLauncherTile, { size: 'small' }),
					_react2.default.createElement(DemoAppLauncherTileWithIconNode, { size: 'small' })
				)
			);
		}
	});
	...
	var DemoAppLauncher = (0, _createReactClass2.default)({
		...
		render: function render() {
			...
			var modalHeaderButton = _react2.default.createElement(_button2.default, { label: 'App Exchange', onClick: (0, _react3.action)('Modal Button clicked!') });
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(DemoAppLauncherTile, { search: this.state.search }),
							_react2.default.createElement(DemoAppLauncherTileWithIconNode, { search: this.state.search }),
							_react2.default.createElement(DemoAppLauncherTileWithIconText, { search: this.state.search }),
							_react2.default.createElement(DemoAppLauncherTile, { search: this.state.search }),
							_react2.default.createElement(DemoAppLauncherTileWithIconNode, { search: this.state.search }),
							_react2.default.createElement(DemoAppLauncherTileWithIconText, { search: this.state.search })
						),
						_react2.default.createElement(
							_section2.default,
							{ title: 'All Apps', toggleable: true },
							_react2.default.createElement(DemoAppLauncherTile, { search: this.state.search }),
							_react2.default.createElement(DemoAppLauncherTileWithTruncatedText, { search: this.state.search }),
							_react2.default.createElement(DemoAppLauncherTileWithDescriptionHeading, { search: this.state.search }),
							_react2.default.createElement(DemoAppLauncherTile, { search: this.state.search }),
							_react2.default.createElement(DemoAppLauncherTileWithTruncatedText, { search: this.state.search }),
							_react2.default.createElement(DemoAppLauncherTileWithDescriptionHeading, { search: this.state.search }),
							_react2.default.createElement(DemoAppLauncherTile, { search: this.state.search }),
	...
	var DemoAppLauncherNoHeaderButton = (0, _createReactClass2.default)({
		...
		render: function render() {
			var search = _react2.default.createElement(_search2.default, { onChange: this.onSearch, placeholder: 'Find an app', assistiveText: 'Find an app' });
	...
	(0, _react3.storiesOf)(_constants.APP_LAUNCHER, module).addDecorator(function (getStory) {
		...
		return _react2.default.createElement(DemoAppLauncher, { isOpen: true });
