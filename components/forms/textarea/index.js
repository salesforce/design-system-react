define(['module', 'react', 'prop-types', 'classnames', 'shortid', './check-props', '../../../utilities/constants'], function (module, _react, _propTypes, _classnames, _shortid, _checkProps, _constants) {
	'use strict';
		...
		render: function render() {
			...
			return _react2.default.createElement(
				...
				labelText && _react2.default.createElement(
					'label',
					{ className: (0, _classnames2.default)('slds-form-element__label', { 'slds-assistive-text': assistiveText && !label }), htmlFor: this.getId() },
