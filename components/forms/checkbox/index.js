  ...
  */
    ...
    */
		...
		render: function render() {
			...
			var props = _objectWithoutProperties(_props, ['ariaControls', 'ariaDescribedby', 'ariaOwns', 'ariaRequired', 'assistiveText', 'checked', 'className', 'disabled', 'id', 'errorText', 'indeterminate', 'label', 'name', 'onBlur', 'onChange', 'onFocus', 'onKeyDown', 'onKeyPress', 'onKeyUp', 'readOnly', 'required', 'role']);
