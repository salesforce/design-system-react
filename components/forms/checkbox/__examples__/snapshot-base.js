define(['exports', 'react', 'create-react-class', '../../../../../components/forms/checkbox'], function (exports, _react, _createReactClass, _checkbox) {
	'use strict';
		...
		render: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(_checkbox2.default, { label: 'Checkbox', id: 'checkbox-base-example' })
				),
				_react2.default.createElement(
					'div',
					{ className: 'slds-col--padded' },
