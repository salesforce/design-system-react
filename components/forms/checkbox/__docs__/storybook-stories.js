define(['module', 'react', 'create-react-class', '@storybook/react', '../../../icon-settings', '../../../../utilities/constants', '../', '../../../button'], function (module, _react, _createReactClass, _react3, _iconSettings, _constants, _, _button) {
	'use strict';
	...
	var CheckboxIndeterminate = (0, _createReactClass2.default)({
		displayName: _constants.FORMS_CHECKBOX + '_INDETERMINATE',
		...
		handleChange: function handleChange(checked, event, data) {
			...
			(0, _react3.action)('handleChange')(checked, event, 'checked: ' + data.checked + ',\n\t\t\tindeterminate: ' + data.indeterminate);
		},
		...
		render: function render() {
			return _react2.default.createElement(
				'div',
				null,
				_react2.default.createElement(_button2.default, { onClick: this.changeToIndeterminate, label: 'Indeterminate' }),
				_react2.default.createElement(_button2.default, { onClick: this.changeToCheck, label: 'Check' }),
				_react2.default.createElement(_button2.default, { onClick: this.changeToUnChecked, label: 'Uncheck' }),
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'p',
						null,
						'Once it is clicked, there is no way to make it go ',
						_react2.default.createElement(
							'em',
							null,
							'back'
