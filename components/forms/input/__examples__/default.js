define(['exports', 'react', 'create-react-class', '../../../../../components/icon-settings', '../../../../../components/forms/input'], function (exports, _react, _createReactClass, _iconSettings, _input) {
	'use strict';
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(_input2.default, { id: 'base-id', label: 'My Label', placeholder: 'My placeholder' })
					),
					_react2.default.createElement(
						'div',
						{ className: 'slds-col--padded' },
