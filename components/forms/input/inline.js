    ...
    */
		...
		triggerEditMode: function triggerEditMode() {
			if (!this.props.disabled) {
				...
				if ((0, _lodash2.default)(this.props.onEnterEditMode)) {
					this.props.onEnterEditMode();
				}
			}
		},
		saveEdits: function saveEdits(option) {
		...
		endEditMode: function endEditMode(option) {
			if (this.willSave) {
			...
			if (this.props.onLeaveEditMode && (0, _lodash2.default)(this.props.onLeaveEditMode)) {
		...
		handleKeyUp: function handleKeyUp(event) {
			if (event.keyCode) {
				if (this.props.onKeyUp && (0, _lodash2.default)(this.props.onKeyUp)) {
