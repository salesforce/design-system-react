define(['module', 'react', 'react-dom', 'lodash.isfunction', '../../button', './index', '../../icon/input-icon', '../../../utilities/key-code', '../../../utilities/constants'], function (module, _react, _reactDom, _lodash, _button, _index, _inputIcon, _keyCode, _constants) {
	'use strict';
