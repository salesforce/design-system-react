define(['module', 'react', 'react-dom', 'lodash.isfunction', '../../button', './index', '../../icon/input-icon', '../../../utilities', '../../../utilities/constants'], function (module, _react, _reactDom, _lodash, _button, _index, _inputIcon, _utilities, _constants) {
	'use strict';
  ...
  */
    ...
    */
		...
		render: function render() {
			...
			var rest = _objectWithoutProperties(_props, ['disabled', 'value', 'name']);
