define(['module', 'react', 'prop-types', 'react-dom', 'lodash.isfunction', '../../button', './index', '../../icon/input-icon', '../../../utilities/key-code', '../../../utilities/constants'], function (module, _react, _propTypes, _reactDom, _lodash, _button, _index, _inputIcon, _keyCode, _constants) {
	'use strict';
