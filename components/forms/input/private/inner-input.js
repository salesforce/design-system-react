define(['exports', 'react', 'prop-types', 'classnames', '../../../../components/spinner'], function (exports, _react, _propTypes, _classnames, _spinner) {
	'use strict';
	...
	var InnerInput = function InnerInput(props) {
		...
		return _react2.default.createElement(
			...
			props.isStatic && _react2.default.createElement(
				'span',
				{ className: 'slds-form-element__static slds-grid slds-grid_align-spread', onClick: props.onClick },
				props.value,
