define(['module', 'react', 'prop-types', 'classnames', 'shortid', '../../icon/input-icon', './private/inner-input', './check-props', '../../../utilities/constants'], function (module, _react, _propTypes, _classnames, _shortid, _inputIcon, _innerInput, _checkProps, _constants) {
	'use strict';
    ...
    */
		...
		render: function render() {
			...
			var labelText = props.label || props.assistiveText; // One of these is required to pass accessibility tests
			...
			return _react2.default.createElement(
				...
				labelText && (props.readOnly ? _react2.default.createElement(
					'span',
					{
