define(['module', 'react', 'prop-types', 'classnames', 'shortid', '../../icon/input-icon', './check-props', '../../../utilities/constants'], function (module, _react, _propTypes, _classnames, _shortid, _inputIcon, _checkProps, _constants) {
	'use strict';
