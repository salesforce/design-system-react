define(['module', 'react', 'prop-types', 'classnames', 'shortid', '../../icon/input-icon', './private/inner-input', '../private/label', './check-props', '../../../utilities/constants'], function (module, _react, _propTypes, _classnames, _shortid, _inputIcon, _innerInput, _label, _checkProps, _constants) {
	'use strict';
