define(['module', 'react', '@storybook/react', '../../../icon-settings', '../../../../utilities/constants', '../../../button', '../', '../../../icon/input-icon'], function (module, _react, _react3, _iconSettings, _constants, _button, _, _inputIcon) {
	...
	(0, _react3.storiesOf)(_constants.FORMS_INPUT, module).addDecorator(function (getStory) {
		...
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(_2.default, { id: 'base-id', label: 'My Label', placeholder: 'My placeholder' })
				),
				_react2.default.createElement(
					'li',
					{ className: 'slds-p-bottom--large' },
		...
		return _react2.default.createElement(
			...
			_react2.default.createElement(_button2.default, { label: 'Test' }),
			_react2.default.createElement(
				'h1',
				{ className: 'slds-text-title_caps slds-p-vertical--medium' },
