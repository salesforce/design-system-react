define(['module', 'react', '@storybook/react', '../../../icon-settings', '../../../../utilities/constants', '../../../button', '../', '../../../icon/input-icon'], function (module, _react, _react3, _iconSettings, _constants, _button, _, _inputIcon) {
	'use strict';
	...
	var clearIcon = _react2.default.createElement(_inputIcon2.default, { assistiveText: 'clear', name: 'clear', category: 'utility' });
	var clearIconClickable = _react2.default.createElement(_inputIcon2.default, { assistiveText: 'clear', name: 'clear', category: 'utility', onClick: iconClicked('Clear icon clicked') });
	var searchIcon = _react2.default.createElement(_inputIcon2.default, { name: 'search', category: 'utility' });
	var searchIconClickable = _react2.default.createElement(_inputIcon2.default, { assistiveText: 'Search', name: 'search', category: 'utility', onClick: iconClicked('Search icon clicked') });
