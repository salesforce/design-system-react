...
var _inline = require('../../../input/inline');
...
(0, _react3.storiesOf)(_constants.FORMS_INLINE_EDIT, module).addDecorator(function (getStory) {
	...
	return _react2.default.createElement(
		...
		_react2.default.createElement(DemoInlineEdit, { name: 'inline-edit-standard', id: 'inline-edit-standard' })
	);
	...
	return _react2.default.createElement(
		...
		_react2.default.createElement(DemoInlineEdit, { name: 'inline-edit-disabled', id: 'inline-edit-disabled', disabled: true })
	);
});