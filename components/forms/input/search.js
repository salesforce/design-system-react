define(['module', 'react', './index', '../../icon/input-icon', '../../../utilities/key-code', '../../../utilities/event', '../../../utilities/constants'], function (module, _react, _index, _inputIcon, _keyCode, _event, _constants) {
	'use strict';
