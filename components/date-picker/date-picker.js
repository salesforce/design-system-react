define(['exports', 'react', '../utilities/dialog', './private/calendar-wrapper', '../icon/input-icon', '../forms/input', 'lodash.isboolean', 'classnames', 'shortid', './check-props', '../../utilities/event', '../../utilities/key-code', '../../utilities/constants'], function (exports, _react, _dialog, _calendarWrapper, _inputIcon, _input, _lodash, _classnames, _shortid, _checkProps, _event, _keyCode, _constants) {
	'use strict';
