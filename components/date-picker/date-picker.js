...
function (_React$Component) {
  ...
  function Datepicker(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "getDatePicker", function (_ref) {
      ...
      return _react.default.createElement(_calendarWrapper.default // Please remove `abbrWeekDayLabels` on the next breaking change.
      , {
    ...
    _defineProperty(_assertThisInitialized(_this), "getDialog", function (_ref2) {
      ...
      return !_this.props.disabled && _this.getIsOpen() ? _react.default.createElement(_dialog.default, {
    ...
    _defineProperty(_assertThisInitialized(_this), "getInputProps", function (_ref3) {
      ...
      var defaultInputProps = {
        iconRight: _react.default.createElement(_inputIcon.default // Remove || for assistiveText at next breaking change
        , {
          assistiveText: {
  ...
  _createClass(Datepicker, [{
    ...
    value: function componentWillMount() {
      ...
      (0, _checkProps.default)(_constants.DATE_PICKER, this.props, _component.default);
    }
  }, {
    ...
    value: function render() {
      ...
      var inputToRender = this.props.children ? _react.default.cloneElement(this.props.children, _objectSpread({}, inputProps)) : _react.default.createElement(_input.default, inputProps);
