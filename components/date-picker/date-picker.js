		...
		value: function getDialog(_ref3) {
			...
			return !this.props.disabled && this.getIsOpen() ? _react2.default.createElement(
				_dialog2.default,
				{
					...
					contentsClassName: (0, _classnames2.default)('slds-datepicker slds-dropdown', { 'slds-dropdown--right': this.props.menuPosition === 'relative' && this.props.align === 'right',
						'slds-dropdown--left': this.props.menuPosition === 'relative' && this.props.align === 'left' }, this.props.className),
