...
function (_React$Component) {
  ...
  function Datepicker(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "getDatePicker", function (_ref) {
      ...
      return (
        /*#__PURE__*/
        _react.default.createElement(_calendarWrapper.default // Please remove `abbrWeekDayLabels` on the next breaking change.
        , {
    ...
    _defineProperty(_assertThisInitialized(_this), "getInputProps", function (_ref3) {
      ...
      var defaultInputProps = {
        iconRight:
        /*#__PURE__*/
        _react.default.createElement(_inputIcon.default // Remove || for assistiveText at next breaking change
        , {
          assistiveText: {
  ...
  _createClass(Datepicker, [{
    ...
    value: function render() {
      ...
      /*#__PURE__*/
      _react.default.cloneElement(this.props.children, _objectSpread({}, inputProps)) :
      /*#__PURE__*/
      _react.default.createElement(_input.default, inputProps);
      return (
        /*#__PURE__*/
