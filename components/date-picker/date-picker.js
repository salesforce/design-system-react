define(['exports', 'react', 'prop-types', '../utilities/dialog', './private/calendar-wrapper', '../icon/input-icon', '../forms/input', 'lodash.assign', 'airbnb-prop-types', 'lodash.isboolean', 'classnames', 'shortid', './check-props', '../iconSettings', '../../utilities/event', '../../utilities/key-code', '../../utilities/constants'], function (exports, _react, _propTypes, _dialog, _calendarWrapper, _inputIcon, _input, _lodash, _airbnbPropTypes, _lodash3, _classnames, _shortid, _checkProps, _iconSettings, _event, _keyCode, _constants) {
	'use strict';
