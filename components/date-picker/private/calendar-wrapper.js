define(['module', 'react', './calendar', './navigation', '../../../utilities/event', '../../../utilities/keys', 'classnames'], function (module, _react, _calendar, _navigation, _event, _keys, _classnames) {
	'use strict';
