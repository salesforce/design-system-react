define(['module', 'react', './calendar', './navigation', '../../../utilities/event', '../../../utilities/key-code', 'classnames'], function (module, _react, _calendar, _navigation, _event, _keyCode, _classnames) {
	'use strict';
