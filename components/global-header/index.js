define(['exports', 'react', 'create-react-class', 'prop-types', '../../utilities/event', '../../utilities/constants'], function (exports, _react, _createReactClass, _propTypes, _event, _constants) {
	'use strict';
