  ...
  _createClass(GlobalHeaderNotifications, [{
    ...
    value: function render() {
      ...
      var popoverProps = (0, _lodash.default)({
        align: 'bottom right',
        body: _react.default.createElement("span", null),
      ...
      return _react.default.createElement(_popover.default, popoverProps, _react.default.createElement(_button.default, _extends({
        assistiveText: {
        ...
        variant: "icon"
      }, buttonAriaProps)), notificationCount > 0 ? _react.default.createElement("span", {
        "aria-hidden": "true",
        className: "slds-notification-badge slds-incoming-notification slds-show-notification"
      }, notificationCount) : _react.default.createElement("span", {
        "aria-hidden": "true",
