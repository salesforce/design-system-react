...
if (process.env.NODE_ENV !== 'production') {
  checkProps = function checkPropsFunction(COMPONENT, props, jsonDoc) {
    if (COMPONENT === _constants.GLOBAL_HEADER_BUTTON || COMPONENT === _constants.GLOBAL_HEADER_DROPDOWN) {
      (0, _componentIsDeprecated.default)(COMPONENT, "".concat(COMPONENT, " has been deprecated in favor of more-specific global header subcomponents. Please see docs for updated examples."));
    }
