   ...
   */
    ...
    */
		...
		render: function render() {
			...
			var rest = _objectWithoutProperties(_props, ['avatar', 'className', 'id', 'isOpen', 'globalAction', 'menu', 'onBlur', 'onClick', 'onFocus', 'onKeyDown', 'onMouseDown', 'onMouseEnter', 'onMouseLeave', 'triggerRef']);
