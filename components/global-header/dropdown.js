define(['module', 'react', 'prop-types', '../menu-dropdown', './private/dropdown-trigger', '../../utilities/constants'], function (module, _react, _propTypes, _menuDropdown, _dropdownTrigger, _constants) {
	'use strict';
