define(['exports', 'react', 'prop-types', 'classnames', '../menu-dropdown', './private/dropdown-trigger', '../../utilities/constants'], function (exports, _react, _propTypes, _classnames, _menuDropdown, _dropdownTrigger, _constants) {
	'use strict';
	...
	var GlobalHeaderProfile = function GlobalHeaderProfile(props) {
		...
		return (
			...
			_react2.default.createElement(
				...
				_extends({ menuPosition: 'relative', nubbinPosition: 'top right' }, rest),
				_react2.default.createElement(_dropdownTrigger2.default, {
					avatar: avatar || defaultAvatar,
					className: (0, _classnames2.default)('slds-m-left--x-small', buttonClassName)
				}),
				children
			)
		);
