define(['exports', 'react', 'classnames', '../menu-dropdown', './dropdown-trigger', '../../utilities/constants'], function (exports, _react, _classnames, _menuDropdown, _dropdownTrigger, _constants) {
	'use strict';
