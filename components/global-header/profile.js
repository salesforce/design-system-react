define(['exports', 'react', 'classnames', '../menu-dropdown', './private/dropdown-trigger', '../../utilities/constants'], function (exports, _react, _classnames, _menuDropdown, _dropdownTrigger, _constants) {
	'use strict';
  ...
  */
	var GlobalHeaderProfile = function GlobalHeaderProfile(props) {
		...
		var rest = _objectWithoutProperties(props, ['avatar', 'buttonClassName', 'children']);
