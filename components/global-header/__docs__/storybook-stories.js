...
var GlobalHeaderDemo = function GlobalHeaderDemo(props) {
  return _react2.default.createElement(_globalHeader2.default, {
    ...
    iconVariant: null,
    label: "Feedback",
    onClick: (0, _addonActions.action)('Feedback Clicked'),
    variant: "neutral"
    ...
    onSelect: (0, _addonActions.action)('Action Selected'),
    options: [{
      label: 'New Note',
      rightIcon: {
        category: 'standard',
    ...
    iconCategory: "utility",
    iconName: "question",
    onClick: (0, _addonActions.action)('Help Clicked')
  }), _react2.default.createElement(_dropdown2.default, {
    openOn: props.openOn,
    assistiveText: {
      icon: 'Setup'
    ...
    onClick: (0, _addonActions.action)('Notifications Clicked')
  }), _react2.default.createElement(_profile2.default, {
    id: "global-header-dropdown-profile-example",
    openOn: props.openOn,
    onClick: (0, _addonActions.action)('Profile Clicked'),
    onSelect: (0, _addonActions.action)('Profile Selected'),
    avatar: props.avatar
