  ...
  _createClass(ProgressBar, [{
    ...
    value: function getDescription(_ref) {
      ...
      if (labels.label) {
        ...
        }, _react.default.createElement("span", null, labels.label), _react.default.createElement("span", null, _react.default.createElement("strong", null, this.props.value, '% ', labels.complete)));
      }
