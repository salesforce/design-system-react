define(['module', 'react', 'create-react-class', '@storybook/react', '../../icon-settings', '../../../../components/progress-indicator', '../../../utilities/constants', '../__examples__/default', '../__examples__/modal', '../__examples__/step-error'], function (module, _react, _createReactClass, _react3, _iconSettings, _progressIndicator, _constants, _default, _modal, _stepError) {
	'use strict';
	...
	}, { id: 1, label: 'tooltip label #2' }, { id: 2, label: _react2.default.createElement(
			'strong',
			null,
			'tooltip label #3'
