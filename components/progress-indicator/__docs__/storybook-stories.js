define(['module', 'react', 'create-react-class', '@storybook/react', '../../icon-settings', '../../../../components/progress-indicator', '../../../utilities/constants', '../__examples__/default', '../__examples__/modal', '../__examples__/stepError'], function (module, _react, _createReactClass, _react3, _iconSettings, _progressIndicator, _constants, _default, _modal, _stepError) {
	'use strict';
	...
	var steps = [{ id: 0, label: _react2.default.createElement(
			'i',
			null,
			'tooltip label #1'
		), assistiveText: 'This is custom text in the assistive text key' }, { id: 1, label: 'tooltip label #2' }, { id: 2, label: _react2.default.createElement(
			'strong',
			null,
			'tooltip label #3'
		) }, { id: 3, label: 'tooltip label #4' }, { id: 4, label: 'tooltip label #5' }];

	var stepsDisabled = [{ id: 3, label: 'tooltip label #4' }, { id: 4, label: 'tooltip label #5' }];

	var manySteps = [{ id: 'a', label: 'tooltip label #1' }, { id: 'b', label: 'tooltip label #2' }, { id: 'c', label: 'tooltip label #3' }, { id: 'd', label: 'tooltip label #4' }, { id: 'e', label: 'tooltip label #5' }, { id: 'f', label: 'tooltip label #6' }, { id: 'g', label: 'tooltip label #7' }, { id: 'h', label: 'tooltip label #8' }, { id: 'i', label: 'tooltip label #9' }];
