...
function (_React$Component) {
  ...
  _createClass(Step, [{
    ...
    value: function buttonIcon(renderIcon, status, props) {
      ...
      }, this.props.step.assistiveText || "".concat(props.assistiveText.step, " ").concat(props.index + 1, ": ").concat(props.step.label, " - ").concat(status))) : _react.default.createElement("button", {
        className: (0, _classnames.default)('slds-button', {
          'slds-button_icon': renderIcon
        }, 'slds-progress__marker', {
          'slds-progress__marker_icon': renderIcon
