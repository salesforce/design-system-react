define(['exports', 'react', 'prop-types', 'classnames', '../../popover-tooltip', '../../../utilities/constants', '../../icon/button-icon'], function (exports, _react, _propTypes, _classnames, _popoverTooltip, _constants, _buttonIcon) {
	'use strict';
	...
	var Step = function (_React$Component) {
		...
		_createClass(Step, [{
			...
			value: function buttonIcon(renderIcon, status, props) {
				...
				var icon = renderIcon ? _react2.default.createElement(_buttonIcon2.default, { category: 'utility', name: this.props.isError ? 'warning' : 'success' }) : null;
