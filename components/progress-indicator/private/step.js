...
function (_React$Component) {
  ...
  _createClass(Step, [{
    ...
    value: function buttonIcon(renderIcon, status, props) {
      ...
      var icon = renderIcon ? _react.default.createElement(_buttonIcon.default, {
        category: "utility",
      ...
      var stepButton = props.isDisabled ? _react.default.createElement("a", {
      ...
      }, this.props.step.assistiveText || _react.default.createElement(_react.default.Fragment, null, "".concat(props.assistiveText.step, " ").concat(props.index + 1, ": "), props.step.label, "- ".concat(status)))) : _react.default.createElement("button", {
        className: (0, _classnames.default)('slds-button', {
          'slds-button_icon': renderIcon
        }, 'slds-progress__marker', {
          'slds-progress__marker_icon': renderIcon
        ...
        className: "slds-assistive-text"
      }, this.props.step.assistiveText || _react.default.createElement(_react.default.Fragment, null, "".concat(props.assistiveText.step, " ").concat(props.index + 1, ": "), props.step.label, status ? " - ".concat(status) : '')));
      return stepButton;
    }
  }, {
    key: "render",
    value: function render() {
      ...
      }, _react.default.createElement(_tooltip.default, tooltipProps, this.buttonIcon(renderIcon, status, this.props)));
    }
  }]);
