...
function (_React$Component) {
  ...
  _createClass(Step, [{
    ...
    value: function buttonIcon(renderIcon, status, props) {
      ...
      /*#__PURE__*/
      _react.default.createElement(_react.default.Fragment, null, "".concat(props.assistiveText.step, " ").concat(props.index + 1, ": "), props.step.label, "- ".concat(status)))) :
      /*#__PURE__*/
      ...
      /*#__PURE__*/
      _react.default.createElement(_react.default.Fragment, null, "".concat(props.assistiveText.step, " ").concat(props.index + 1, ": "), props.step.label, status ? " - ".concat(status) : '')));
      return stepButton;
    }
  }, {
    key: "render",
