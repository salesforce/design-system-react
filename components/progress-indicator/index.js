define(['exports', 'react', 'prop-types', 'airbnb-prop-types', 'lodash.assign', 'shortid', '../../utilities/constants', 'lodash.find', './private/step', './private/progress'], function (exports, _react, _propTypes, _airbnbPropTypes, _lodash, _shortid, _constants, _lodash3, _step, _progress) {
	'use strict';
