define(['exports', 'react', 'prop-types', 'classnames'], function (exports, _react, _propTypes, _classnames) {
	...
	var PROGRESS_RING_SHAPE = 'SLDSProgressRingShape'; /* Copyright (c) 2015-present, salesforce.com, inc. All rights reserved */
  ...
  */
	var ProgressRingShape = function ProgressRingShape(props) {
		return _react2.default.createElement(
			'div',
			{ id: props.id, className: (0, _classnames2.default)('slds-progress-ring', props.className) },
