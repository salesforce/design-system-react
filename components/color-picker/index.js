...
function (_React$Component) {
  ...
  _createClass(ColorPicker, [{
    ...
    value: function setWorkingColor(event, color) {
      var newColor = _color.default.getNewColor(color, this.props.events.onValidateWorkingColor, this.state.workingColor);
    ...
    value: function handleNavigate(property) {
      ...
      return function (event, _ref9) {
        ...
        var newColor = _color.default.getDeltaColor(colorProperties, _this4.props.events.onValidateWorkingColor, _this4.state.workingColor);
