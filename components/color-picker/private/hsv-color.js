...
function (_React$Component) {
  ...
  _createClass(HsvColor, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", null, _react.default.createElement("p", {
      ...
      }, this.props.assistiveText.saturationValueGrid), _react.default.createElement("div", {
        ...
        className: "slds-assistive-text"
      }, "Saturation ".concat(workingColor.hsv.saturation, "% Brightness: ").concat(workingColor.hsv.value, "%")))), _react.default.createElement("div", {
        className: "slds-color-picker__hue-and-preview"
      }, _react.default.createElement("label", {
        className: "slds-assistive-text",
        htmlFor: "color-picker-input-range-".concat(this.props.id)
      }, this.props.assistiveText.hueSlider), _react.default.createElement("input", {
        type: "range",
        min: "0",
        max: "360",
