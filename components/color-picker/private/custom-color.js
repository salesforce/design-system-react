...
function (_React$Component) {
  ...
  _createClass(CustomColor, [{
    ...
    value: function render() {
      ...
      }, _react.default.createElement(_hsvColor.default, {
      ...
      }), _react.default.createElement(_customColorForm.default, {
        color: this.props.color,
        id: this.props.id,
      ...
      }), this.props.errorTextWorkingColor || this.props.color.errors ? _react.default.createElement("p", {
