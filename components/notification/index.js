...
function (_React$Component) {
  ...
  _createClass(Notification, [{
    ...
    value: function getClassName() {
      ...
      return (0, _classnames2.default)(this.props.className, 'slds-notify', (_classNames = {}, _defineProperty(_classNames, "slds-notify_".concat(this.props.variant), this.props.variant), _defineProperty(_classNames, "slds-theme_".concat(this.props.theme), this.props.theme), _defineProperty(_classNames, 'slds-theme_alert-texture', this.props.texture), _classNames));
    }
    /*
