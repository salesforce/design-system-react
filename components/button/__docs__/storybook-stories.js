...
var _baseNeutral = require("../__examples__/base-neutral");

var _baseNeutral2 = _interopRequireDefault(_baseNeutral);

var _brandDisabledDestructiveInverse = require("../__examples__/brand-disabled-destructive-inverse");

var _brandDisabledDestructiveInverse2 = _interopRequireDefault(_brandDisabledDestructiveInverse);

var _buttonIcons = require("../__examples__/button-icons");

var _buttonIcons2 = _interopRequireDefault(_buttonIcons);
...
(0, _react3.storiesOf)(_constants.BUTTON, module).addDecorator(function (getStory) {
  ...
  return _react2.default.createElement(_baseNeutral2.default, null);
}).add('Doc site Brand Disabled', function () {
  return _react2.default.createElement(_brandDisabledDestructiveInverse2.default, null);
}).add('Doc site Button Icons', function () {
  return _react2.default.createElement(_buttonIcons2.default, null);
});