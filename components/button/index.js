define(['exports', 'react', 'prop-types', 'classnames', '../icon/button-icon', '../popover-tooltip', '../../utilities/constants'], function (exports, _react, _propTypes, _classnames, _buttonIcon, _popoverTooltip, _constants) {
	'use strict';
