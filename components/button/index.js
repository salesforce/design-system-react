  ...
  function Button(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderButton", function () {
      ...
      return (
        ...
        }, ariaProps, formProps), _this.props.iconPosition === 'right' ? _this.renderLabel() : null, _this.props.iconName || _this.props.iconPath ? _this.renderIcon(_this.props.iconName) : null, _this.props.iconVariant === 'more' ? /*#__PURE__*/_react.default.createElement(_buttonIcon.default, {
          category: "utility",
          name: "down",
          size: "x-small",
