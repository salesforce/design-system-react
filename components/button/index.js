...
var _getAriaProps = require("../../utilities/get-aria-props");

var _getAriaProps2 = _interopRequireDefault(_getAriaProps);
...
function (_React$Component) {
  ...
  function Button() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_ref = Button.__proto__ || Object.getPrototypeOf(Button)).call.apply(_ref, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this), "getClassName", {
      ...
      writable: true,
      value: function value() {
        var ariaProps = (0, _getAriaProps2.default)(_this.props);
        ...
        }, ariaProps), _this.props.iconPosition === 'right' ? _this.renderLabel() : null, _this.props.iconName || _this.props.iconPath ? _this.renderIcon(_this.props.iconName) : null, _this.props.iconVariant === 'more' ? _react2.default.createElement(_buttonIcon2.default, {
          category: "utility",
          name: "down",
          size: "x-small",
