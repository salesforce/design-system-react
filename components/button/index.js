...
function (_React$Component) {
  ...
  function Button() {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderButton", function () {
      ...
      return (// eslint-disable-next-line react/button-has-type
        ...
        }, ariaProps, formProps), _this.props.iconPosition === 'right' ? _this.renderLabel() : null, _this.props.iconName || _this.props.iconPath ? _this.renderIcon(_this.props.iconName) : null, _this.props.iconVariant === 'more' ? _react.default.createElement(_buttonIcon.default, {
          category: "utility",
          name: "down",
          size: "x-small",
  ...
  _createClass(Button, [{
    ...
    value: function componentWillMount() {
      ...
      (0, _checkProps.default)(_constants.BUTTON, this.props, _component.default);
    }
  }, {
    key: "render",
