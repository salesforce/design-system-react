define(['exports', './settings', './button', './button-group', './button-stateful', './bread-crumb', './card', './card/empty', './card/filter', './forms/checkbox', './global-header', './global-header/button', './global-header/dropdown', './global-header/profile', './global-header/search', './global-navigation-bar', './global-navigation-bar/region', './global-navigation-bar/link', './global-navigation-bar/dropdown', './data-table', './data-table/cell', './data-table/column', './data-table/row-actions', './date-picker', './icon', './icon/button-icon', './forms/input/inline', './forms/input', './icon/input-icon', './lookup', './media-object', './menu-dropdown', './menu-picklist', './modal', './modal/trigger', './navigation', './notification', './page-header', './popover', './tooltip', './spinner', './time-picker', './tabs', './tabs/panel', './utilities/utility-icon'], function (exports, _settings, _button, _buttonGroup, _buttonStateful, _breadCrumb, _card, _empty, _filter, _checkbox, _globalHeader, _button3, _dropdown, _profile, _search, _globalNavigationBar, _region, _link, _dropdown3, _dataTable, _cell, _column, _rowActions, _datePicker, _icon, _buttonIcon, _inline, _input, _inputIcon, _lookup, _mediaObject, _menuDropdown, _menuPicklist, _modal, _trigger, _navigation, _notification, _pageHeader, _popover, _tooltip, _spinner, _timePicker, _tabs, _panel, _utilityIcon) {
  'use strict';
  ...
  exports.SLDSTabsPanel = _panel2.default;
  exports.TabsPanel = _panel2.default;
  exports.SLDSPanel = _panel2.default;
  exports.Panel = _panel2.default;
  exports.SLDSPane = _panel2.default;
  exports.Pane = _panel2.default;
