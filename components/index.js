define(['exports', './SLDSSettings', './button', './button-group', './button-stateful', './bread-crumb', './card', './card/empty', './card/filter', './forms/checkbox', './global-navigation-bar', './global-navigation-bar/region', './global-navigation-bar/link', './global-navigation-bar/dropdown', './data-table', './data-table/cell', './data-table/column', './data-table/row-actions', './date-picker', './icon', './icon/button-icon', './forms/input/inline', './forms/input', './lookup', './menu-dropdown', './menu-picklist', './modal', './modal/trigger', './notification', './page-header', './popover-tooltip', './spinner', './time-picker', './utilities/utility-icon'], function (exports, _SLDSSettings2, _button, _buttonGroup, _buttonStateful, _breadCrumb, _card, _empty, _filter, _checkbox, _globalNavigationBar, _region, _link, _dropdown, _dataTable, _cell, _column, _rowActions, _datePicker, _icon, _buttonIcon, _inline, _input, _lookup, _menuDropdown, _menuPicklist, _modal, _trigger, _notification, _pageHeader, _popoverTooltip, _spinner, _timePicker, _utilityIcon) {
  'use strict';
