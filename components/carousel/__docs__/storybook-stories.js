...
var _threeItemsControlled = _interopRequireDefault(require("../__examples__/three-items-controlled"));
...
(0, _react2.storiesOf)(_constants.CAROUSEL, module).add('Default (1 item) NoImageTest', function () {
  ...
  return _react.default.createElement(_threeItemsControlled.default, {
    action: _addonActions.action
  });
