    ...
    value: function render() {
      ...
      return (
        ...
        _react2.default.createElement("div", {
          className: (0, _classnames2.default)("slds-dropdown-trigger slds-dropdown-trigger_".concat(openOn), {
            'slds-is-open': isOpen
          }, triggerClassName),
          id: id,
          onBlur: onBlur,
...
Object.defineProperty(Trigger, "displayName", {
  configurable: true,
  enumerable: true,
  writable: true,
  value: _constants.MENU_DROPDOWN_TRIGGER
});
Object.defineProperty(Trigger, "propTypes", {
  configurable: true,
  enumerable: true,
  writable: true,
  value: {
