define(['module', 'react', 'create-react-class', '@storybook/react', '../../icon-settings', '../../../utilities/constants', '../../menu-dropdown', '../../menu-dropdown/menu-dropdown', '../../utilities/menu-list', '../../button', '../../menu-dropdown/button-trigger'], function (module, _react, _createReactClass, _react3, _iconSettings, _constants, _menuDropdown, _menuDropdown3, _menuList, _button, _buttonTrigger) {
	...
	var getDropdown = function getDropdown(props) {
		return _react2.default.createElement(_menuDropdown2.default, _extends({}, props, { onClose: (0, _react3.action)('Closed'), onOpen: (0, _react3.action)('Opened') }));
	};
	...
	var getDropdownCustomTrigger = function getDropdownCustomTrigger(props) {
		return _react2.default.createElement(
			_menuDropdown2.default,
			_extends({}, props, { onClose: (0, _react3.action)('Closed'), onOpen: (0, _react3.action)('Opened') }),
			_react2.default.createElement(
				_buttonTrigger2.default,
				null,
				_react2.default.createElement(_button2.default, { iconCategory: 'utility', iconName: 'settings' })
			)
		);
	};
