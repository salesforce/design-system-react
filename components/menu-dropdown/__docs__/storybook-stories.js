define(['module', 'react', 'create-react-class', '@storybook/react', '../../icon-settings', '../../../utilities/constants', '../../menu-dropdown', '../../menu-dropdown/menu-dropdown', '../../utilities/menu-list', '../../button', '../../menu-dropdown/button-trigger'], function (module, _react, _createReactClass, _react3, _iconSettings, _constants, _menuDropdown, _menuDropdown3, _menuList, _button, _buttonTrigger) {
	'use strict';
	...
	var options = [{ className: 'custom-li-class',
		divider: 'bottom',
		label: 'A Header',
		type: 'header'
	}, { disabled: true, label: 'An option that is Super Super Long', value: 'A0' }, { label: 'Custom Class', className: 'custom-item-class', value: 'classssss' }, {
		href: 'http://sfdc.co/',
		id: 'custom-li-id',
		label: 'Has a value',
		leftIcon: {
		...
		type: 'divider'
	}, { label: 'C Option', value: 'C0' }, { label: 'D Option', value: 'D0' }, { label: 'E Option', value: 'E0' }, { label: 'A1 Option', value: 'A1' }, { label: 'B2 Option', value: 'B1' }, { label: 'C2 Option', value: 'C1' }, { label: 'D2 Option', value: 'D1' }, { label: 'E2 Option Super Super Long', value: 'E1' }];
	...
	var DropdownControlled = (0, _createReactClass2.default)({
		...
		handleOpen: function handleOpen() {
			(0, _react3.action)('Force Open').apply(undefined, arguments);
			this.setState({ forcedState: true });
		},
		handleClose: function handleClose() {
			(0, _react3.action)('Force Closed').apply(undefined, arguments);
		...
		render: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					'div',
					{ className: 'slds-col' },
					_react2.default.createElement(_button2.default, { label: 'Force Open Dropdown', onClick: this.handleOpen }),
					_react2.default.createElement(_button2.default, { label: 'Force Close Dropdown', onClick: this.handleClose }),
					_react2.default.createElement(_button2.default, { label: 'Reset Dropdown', onClick: this.handleButtonClickReset }),
					_react2.default.createElement(_button2.default, { label: 'Toggle Option A disabled', onClick: this.toggleDisabledOption })
				)
			);
		}
	});
	...
	var getDropdownPositioned = function getDropdownPositioned(props) {
		...
		_menuDropdown3.DropdownNubbinPositions.forEach(function (position) {
			positionedDropdowns.push(_react2.default.createElement(
				'div',
				{ className: 'slds-col slds-size--1-of-3', style: { minHeight: '500px' } },
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						null,
						_react2.default.createElement(_button2.default, { iconVariant: 'container', iconName: 'settings', label: position })
					)
				)
			));
		});
		...
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				'div',
				{ className: 'slds-col', style: { minHeight: '500px' } },
				_react2.default.createElement(
					_menuDropdown2.default,
					_extends({}, props, {
					...
					_react2.default.createElement(
						_buttonTrigger2.default,
						null,
						_react2.default.createElement(_button2.default, { iconVariant: 'container', iconName: 'settings', assistiveText: 'top right' })
					)
				)
			)
		);
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'a',
								{ className: 'slds-m-right--medium', href: 'javascript:void(0)', onClick: props.onClick },
								'Settings'
							),
							_react2.default.createElement(
								'a',
	...
	var getDropdownCustomContent = function getDropdownCustomContent(props) {
		return _react2.default.createElement(
			...
			_react2.default.createElement(_menuList2.default, { options: [{ label: 'Custom Content Option' }].concat(options) })
		);
	};
	...
	(0, _react3.storiesOf)(_constants.MENU_DROPDOWN, module).addDecorator(function (getStory) {
		...
		return getDropdown({
			...
			onClick: function onClick() {
				(0, _react3.action)('Clicked').apply(undefined, arguments);
			},
			onSelect: function onSelect() {
				(0, _react3.action)('Selected').apply(undefined, arguments);
			},
			options: options
		});
