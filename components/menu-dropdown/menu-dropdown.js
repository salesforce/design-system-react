define(['module', 'react', 'react-dom', 'classnames', 'lodash.isboolean', 'lodash.isfunction', 'shortid', '../utilities/dialog', '../menu-list/list', '../menu-list/list-item', '../menu-list/list-item-label', './button-trigger', './check-props', '../../utilities/keyboard-navigable', '../../utilities/EventUtil', '../../utilities/KEYS', '../../utilities/constants'], function (module, _react, _reactDom, _classnames, _lodash, _lodash3, _shortid, _dialog, _list, _listItem, _listItemLabel, _buttonTrigger, _checkProps, _keyboardNavigable, _EventUtil, _KEYS, _constants) {
	'use strict';
