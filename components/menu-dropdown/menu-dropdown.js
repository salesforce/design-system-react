...
var MenuDropdown = (0, _createReactClass2.default)({
  ...
  renderInlineMenu: function renderInlineMenu(customContent, isOpen) {
    ...
    if (this.props.nubbinPosition) {
      ...
      positionClassName = (0, _classnames2.default)("slds-nubbin--".concat(positions.join('-')), positions.map(function (position) {
  ...
  renderDialog: function renderDialog(customContent, isOpen, outsideClickIgnoreClass) {
    ...
    return isOpen ? _react2.default.createElement(_dialog2.default, {
      ...
      style: this.props.menuStyle || (0, _lodash2.default)({}, this.props.menuStyle, {
        marginTop: marginTop
      }),
