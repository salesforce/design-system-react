...
function (_React$Component) {
  ...
  function MenuDropdown() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_ref = MenuDropdown.__proto__ || Object.getPrototypeOf(MenuDropdown)).call.apply(_ref, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this), "state", {
      ...
      writable: true,
      value: function value() {
        return !!((0, _lodash2.default)(_this.props.isOpen) ? _this.props.isOpen : _this.state.isOpen);
      }
      ...
      value: function value(index) {
        ...
        if (index !== undefined) {
          var menuId = (0, _lodash4.default)(_this.getId) ? _this.getId() : _this.props.id;
      ...
      value: function value(focusedIndex) {
        ...
        var menu = (0, _lodash4.default)(_this.getMenu) ? _this.getMenu() : getMenu(_assertThisInitialized(_this));
        var menuItem = (0, _lodash4.default)(_this.getMenuItem) ? _this.getMenuItem(focusedIndex, menu) : getMenuItem(_this.getListItemId(focusedIndex));
