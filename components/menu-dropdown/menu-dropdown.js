define(['module', 'react', 'react-dom', 'classnames', 'lodash.isfunction', 'shortid', '../popover', '../menu-list/list', '../menu-list/list-item', '../menu-list/list-item-label', './button-trigger', './check-props', '../../utilities/keyboard-navigable', '../../utilities', '../../utilities/constants'], function (module, _react, _reactDom, _classnames, _lodash, _shortid, _popover, _list, _listItem, _listItemLabel, _buttonTrigger, _checkProps, _keyboardNavigable, _utilities, _constants) {
	'use strict';
    ...
    */
		...
		renderSimplePopover: function renderSimplePopover(customContent, isOpen) {
			return isOpen ? _react2.default.createElement(
				'div',
				{
					className: (0, _classnames2.default)('slds-dropdown', 'slds-dropdown--' + this.props.align, this.props.className),
