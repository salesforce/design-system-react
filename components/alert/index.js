...
function (_React$Component) {
  ...
  _createClass(Alert, [{
    ...
    value: function componentWillMount() {
      ...
      (0, _checkProps.default)(_constants.ALERT, this.props, _component.default);
    }
  }, {
    ...
    value: function render() {
      ...
      var defaultIcons = {
        ...
        offline: _react.default.createElement(_icon.default, {
          category: "utility",
          name: "offline"
        }),
      ...
      }, assistiveTextVariant[this.props.variant]), clonedIcon, _react.default.createElement("h2", null, heading, ' ', labels.headingLink ? _react.default.createElement("a", {
        onClick: this.props.onClickHeadingLink,
        href: "javascript:void(0);"
      }, labels.headingLink) : null), this.props.dismissible ? _react.default.createElement(_button.default, {
        assistiveText: {
