define(['exports', 'react', 'prop-types', '../../utilities/class-names', '../button', '../icon', './check-props', '../../utilities/constants', 'lodash.assign', '../../utilities/dom-element-focus', 'airbnb-prop-types'], function (exports, _react, _propTypes, _classNames, _button, _icon, _checkProps, _constants, _lodash, _domElementFocus, _airbnbPropTypes) {
	'use strict';
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(
						...
						labels.headingLink ? _react2.default.createElement(
							'a',
							{ onClick: this.props.onClickHeadingLink, href: 'javascript:void(0);' },
							labels.headingLink
						) : null
					),
