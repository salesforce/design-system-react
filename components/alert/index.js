...
function (_React$Component) {
  ...
  _createClass(Alert, [{
    ...
    value: function componentWillMount() {
      ...
      (0, _checkProps2.default)(_constants.ALERT, this.props, _docs2.default);
    }
  }, {
    ...
    value: function render() {
      ...
      var labels = (0, _lodash2.default)({}, defaultProps.labels, this.props.labels); // BACKWARD COMPATIBILITY WITH NOTIFICATION
      ...
      var defaultIcons = {
        ...
        offline: _react2.default.createElement(_icon2.default, {
          category: "utility",
          name: "offline"
        }),
      ...
      }, assistiveTextVariant[this.props.variant]), clonedIcon, _react2.default.createElement("h2", null, heading, ' ', labels.headingLink ? _react2.default.createElement("a", {
        onClick: this.props.onClickHeadingLink,
        href: "javascript:void(0);"
      }, labels.headingLink) : null), this.props.dismissible ? _react2.default.createElement(_button2.default, {
        assistiveText: {
