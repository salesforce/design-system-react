  ...
  _createClass(RadioButtonGroup, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement("fieldset", {
        ...
        className: (0, _classnames2.default)('slds-form-element__legend', 'slds-form-element__label', this.props.assistiveText.label ? 'slds-assistive-text' : '')
      }, this.props.required ? _react2.default.createElement("abbr", {
        className: "slds-required",
        title: "required"
      }, "*") : null, this.props.assistiveText.label ? this.props.assistiveText.label : this.labels.label), _react2.default.createElement("div", {
