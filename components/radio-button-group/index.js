define(['exports', 'react', 'prop-types', 'classnames', 'shortid', 'lodash.assign', 'airbnb-prop-types', '../../utilities/constants'], function (exports, _react, _propTypes, _classnames, _shortid, _lodash, _airbnbPropTypes, _constants) {
	'use strict';
