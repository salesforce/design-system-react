...
var FileActions = function FileActions(props) {
  var actions = _react.default.createElement("div", {
    className: "slds-file__actions-menu"
  }, _react.default.createElement("div", {
    className: "slds-button-group",
    role: "group"
  }, typeof props.onClickDownload === 'function' ? _react.default.createElement(_button.default, {
    type: "button",
    variant: "icon",
    iconSize: "x-small",
  ...
  })) : null, props.moreActionsDropdown ? _react.default.cloneElement(props.moreActionsDropdown, {
    assistiveText: {
