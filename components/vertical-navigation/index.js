 ...
 */
var VerticalNavigation = (0, _createReactClass2.default)({
  displayName: _constants.VERTICAL_NAVIGATION,
  propTypes: {
    /**
  ...
  render: function render() {
    ...
    return _react2.default.createElement("div", {
      id: rootId,
      className: (0, _classnames2.default)('slds-grid', 'slds-grid_vertical', 'slds-navigation-list_vertical', {
