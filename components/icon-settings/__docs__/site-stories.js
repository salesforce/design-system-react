...
const siteStories = [
	require('raw-loader!design-system-react/icon-settings/__examples__/icon-path.jsx'),
	require('raw-loader!design-system-react/icon-settings/__examples__/sprite.jsx')
];
