define(['module', 'raw-loader!design-system-react/components/icon-settings/__examples__/icon-path.jsx', 'raw-loader!design-system-react/components/icon-settings/__examples__/sprite.jsx'], function (module) {
	'use strict';
