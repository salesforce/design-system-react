...
var _onRequestIconPath = require("../__examples__/on-request-icon-path");

var _onRequestIconPath2 = _interopRequireDefault(_onRequestIconPath);
...
}).add('Base: OnRequestIconPath', function () {
  return _react2.default.createElement(_onRequestIconPath2.default, null);
});