...
function (_React$Component) {
  ...
  function Dialog() {
    ...
    _defineProperty(_assertThisInitialized(_this), "getPopperStyles", function () {
      ...
      var right = 'inherit';
      var leftValue = _this.props.direction === _UNSAFE_direction.DIRECTIONS.RTL ? right : left;
      var rightValue = _this.props.direction === _UNSAFE_direction.DIRECTIONS.RTL ? 0 : right;
  ...
  _createClass(Dialog, [{
    ...
    value: function render() {
      ...
      var contents = _react.default.createElement(outerTag, _objectSpread({
