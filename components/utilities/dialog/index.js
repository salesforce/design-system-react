define(['exports', 'react', 'create-react-class', 'prop-types', 'react-dom', 'classnames', 'react-onclickoutside', 'tether-drop', '../../../utilities/event', '../../../utilities/key-code', '../../../utilities/dom-element-focus', '../../../utilities/constants', '../../icon-settings'], function (exports, _react, _createReactClass, _propTypes, _reactDom, _classnames, _reactOnclickoutside, _tetherDrop, _event, _keyCode, _domElementFocus, _constants, _iconSettings) {
	'use strict';
 ...
 */
    ...
    */
			...
			return (
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						{ iconPath: this.props.context.iconPath },
						this.props.children
					)
				)
			);
	...
	exports.default = (0, _reactOnclickoutside2.default)(Dialog);
});