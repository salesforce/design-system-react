...
var _iconSettings = _interopRequireWildcard(require("../../icon-settings"));
    ...
    value: function render() {
      ...
      var subRenders = {
        ...
        overflowBoundaryElement: function overflowBoundaryElement() {
          ...
          var truthyIconSettingsContext = Object.keys(_this2.context).filter(function (key) {
...
Dialog.contextType = _iconSettings.IconSettingsContext;
