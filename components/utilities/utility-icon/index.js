...
var UtilityIcon = function UtilityIcon(_ref, context) {
	...
	var output = SLDS_ICONS_UTILITY[name.toLowerCase()] || icon ? _react2.default.createElement(_svg2.default, _extends({ data: data, name: name }, rest)) : _react2.default.createElement(
		'svg',
		rest,
