...
var Label = function Label(props) {
  ...
  var subRenders = {
    base: _react2.default.createElement("label", {
    ...
    static: _react2.default.createElement("span", {
      className: (0, _classnames2.default)('slds-form-element__label', props.className)
    }, labelText)
  };
