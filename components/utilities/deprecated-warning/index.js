...
var DeprecatedWarning = function DeprecatedWarning() {
  ...
  }, _react.default.createElement(_container.default, null, _react.default.createElement(_alert.default, {
    labels: {
      heading: _react.default.createElement("span", null, _react.default.createElement("strong", null, "Deprecated component."), " No fit and finish bug fixes will be accepted for this component.")
    },
    variant: "error"
  })));
}; // ### Display Name
