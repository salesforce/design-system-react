define(['exports', 'react', 'prop-types', 'lodash.assign', '../../../utilities/key-code', '../../../utilities/key-callbacks', '../../../utilities/event', 'airbnb-prop-types', '../../../components/pill'], function (exports, _react, _propTypes, _lodash, _keyCode, _keyCallbacks, _event, _airbnbPropTypes, _pill) {
	'use strict';
   ...
   */
	...
	var handleKeyDown = function handleKeyDown(event, _ref) {
		...
		(0, _keyCallbacks2.default)(event, {
			callbacks: (_callbacks = {}, _defineProperty(_callbacks, _keyCode2.default.BACKSPACE, { callback: events.onRequestRemove, data: data }), _defineProperty(_callbacks, _keyCode2.default.DELETE, { callback: events.onRequestRemove, data: data }), _defineProperty(_callbacks, _keyCode2.default.LEFT, {
				callback: events.onRequestFocusOnPreviousPill,
				data: _extends({}, data, { direction: 'previous' })
			}), _defineProperty(_callbacks, _keyCode2.default.RIGHT, {
				callback: events.onRequestFocusOnNextPill,
				data: _extends({}, data, { direction: 'next' })
			}), _callbacks)
		});
	};
