define(['module', 'react', 'classnames', '../../icon', './item-label', '../../../utilities', '../../../utilities/constants'], function (module, _react, _classnames, _icon, _itemLabel, _utilities, _constants) {
	'use strict';
