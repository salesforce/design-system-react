define(['module', 'react', 'prop-types', 'classnames', '../../icon', './item-label', '../../../utilities', '../../../utilities/constants'], function (module, _react, _propTypes, _classnames, _icon, _itemLabel, _utilities, _constants) {
	'use strict';
