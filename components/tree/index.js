define(['module', 'react', 'prop-types', './private/branch', 'classnames', './check-props', '../../utilities/constants'], function (module, _react, _propTypes, _branch, _classnames, _checkProps, _constants) {
	'use strict';
