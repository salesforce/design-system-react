define(['exports', 'react', 'prop-types', './private/branch', 'classnames', './check-props', '../../utilities/constants'], function (exports, _react, _propTypes, _branch, _classnames, _checkProps, _constants) {
	'use strict';
		...
		_createClass(Tree, [{
			...
			value: function render() {
				...
				return _react2.default.createElement(
					'div',
					{ id: this.props.id, className: (0, _classnames2.default)('slds-tree_container', this.props.className) /* role="application" */ },
					_react2.default.createElement(
						'h4',
						{
							className: (0, _classnames2.default)('slds-text-title--caps', { 'slds-assistive-text': this.props.assistiveText }),
