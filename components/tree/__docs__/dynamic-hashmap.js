...
var _tree = _interopRequireDefault(require("../../../utilities/sample-data/tree"));
...
var base = (0, _normalizr.normalize)(_tree.default.base, nodeEntity).entities.nodes;
var initialExpandedSelected = (0, _normalizr.normalize)(_tree.default.initialState, nodeEntity).entities.nodes;
var large = (0, _normalizr.normalize)(_tree.default.large, nodeEntity).entities.nodes;
var hashmap = {
  base: base,
  large: large,
