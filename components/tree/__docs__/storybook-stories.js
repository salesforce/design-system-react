...
(0, _react3.storiesOf)(_constants.TREE, module).addDecorator(function (getStory) {
	...
	return _react2.default.createElement(DemoTree, { heading: 'Miscellaneous Foods' });
	...
	return _react2.default.createElement(DemoTree, { heading: 'Miscellaneous Foods', noBranchSelection: true });
}).add('Single Selection', function () {
	return _react2.default.createElement(DemoTree, { heading: 'Miscellaneous Foods', singleSelection: true });
}).add('Assistive Heading', function () {
	return _react2.default.createElement(DemoTree, { assistiveText: 'Miscellaneous Foods' });
	...
	return _react2.default.createElement(DemoTree, { heading: 'Results for fruit', searchable: true });
});