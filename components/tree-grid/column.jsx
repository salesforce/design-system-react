 ...
 */
class TreeGridColumn extends React.Component {
	render() {
		return (
			<th
				...
				scope="col"
				style={{
					width: this.props.initialWidth ? this.props.initialWidth : 'auto',
				}}
			>
				<a
				...
				<Button
					...
					assistiveText={{
						icon: `Show ${this.props.label} column actions`,
					}}
				/>
				<div className="slds-resizable">
					<input
						type="range"
						aria-label={`${this.props.label} column width`}
