...
function (_React$Component) {
  ...
  _createClass(Example, [{
    ...
    value: function render() {
      return _react.default.createElement(_iconSettings.default, {
      ...
      }, "Base Input with visible label"), _react.default.createElement(_input.default, {
        id: "base-id",
        label: "My Label",
        ...
        className: "slds-text-title_caps slds-p-vertical_medium"
      }, "Base Input with hidden label (assistive text)"), _react.default.createElement(_input.default, {
        assistiveText: {
          label: 'My label'
        },
        ...
        className: "slds-text-title_caps slds-p-vertical_medium"
      }, "Base Input with Fixed Text"), _react.default.createElement(_input.default, {
        id: "fixed-text-id",
        fixedTextLeft: "$",
        label: "Total amount",
