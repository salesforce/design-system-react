...
function (_React$Component) {
  ...
  function Input() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_ref = Input.__proto__ || Object.getPrototypeOf(Input)).call.apply(_ref, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this), "getId", {
      configurable: true,
      enumerable: true,
      writable: true,
  ...
  _createClass(Input, [{
    ...
    value: function render() {
      ...
      var fieldLevelHelpTooltip;

      if ((this.props.label || this.props.assistiveText && this.props.assistiveText.label) && this.props.fieldLevelHelpTooltip) {
        var defaultTooltipProps = {
          triggerClassName: 'slds-form-element__icon',
          triggerStyle: {
            position: 'static'
          },
          children: _react2.default.createElement(_button2.default, {
            assistiveText: {
              icon: assistiveText.fieldLevelHelpButton
            },
        ...
        var tooltipProps = _objectSpread({}, defaultTooltipProps, this.props.fieldLevelHelpTooltip.props);

        fieldLevelHelpTooltip = _react2.default.createElement(_tooltip2.default, tooltipProps);
      }
      ...
      }), fieldLevelHelpTooltip, _react2.default.createElement(_innerInput2.default, {
...
Object.defineProperty(Input, "propTypes", {
  ...
  value: {
    ...
    assistiveText: _propTypes2.default.shape({
      ...
      fieldLevelHelpButton: _propTypes2.default.string
    }),
