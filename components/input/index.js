...
function (_React$Component) {
  ...
  function Input(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "getIconRender", function (position, iconPositionProp) {
      ...
      if (_this.props[iconPositionProp] && position && _this.props[iconPositionProp]) {
        icon = _react.default.cloneElement(_this.props[iconPositionProp], {
          iconPosition: "".concat(position)
        });
      } else if (deprecatedProps.name) {
        icon = _react.default.createElement(_inputIcon.default, _extends({
  ...
  _createClass(Input, [{
    ...
    value: function componentWillMount() {
      ...
      (0, _checkProps.default)(_constants.INPUT, this.props, _component.default);
    ...
    value: function render() {
      ...
      }) : null, _react.default.createElement(_innerInput.default, {
      ...
      }), this.props.errorText && _react.default.createElement("div", {
        id: this.getErrorId(),
