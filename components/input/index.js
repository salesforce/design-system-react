  ...
  function Input(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "getIconRender", function (position, iconPositionProp) {
      ...
      if (_this.props[iconPositionProp] && position && _this.props[iconPositionProp]) {
        icon =
        /*#__PURE__*/
        _react.default.cloneElement(_this.props[iconPositionProp], {
          iconPosition: "".concat(position)
        });
      } else if (deprecatedProps.name) {
        icon =
        /*#__PURE__*/
        _react.default.createElement(_inputIcon.default, _extends({
  ...
  _createClass(Input, [{
    ...
    value: function render() {
      ...
      return (
        ...
        /*#__PURE__*/
        _react.default.createElement(_fieldLevelHelpTooltip.default, {
          assistiveText: {
        ...
        /*#__PURE__*/
        _react.default.createElement(_innerInput.default, {
