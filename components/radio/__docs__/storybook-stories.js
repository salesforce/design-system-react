...
function (_React$Component) {
  ...
  _createClass(RadioExample, [{
    ...
    value: function render() {
      ...
      }, _react.default.createElement(_default.default, null));
    }
  }]);
...
(0, _react2.storiesOf)(_constants.RADIO, module).addDecorator(function (getStory) {
  return _react.default.createElement("div", {
    className: "slds-p-around_medium"
  }, getStory());
}).add('Base', function () {
  return _react.default.createElement(RadioExample, {
    heading: "Base"
  });
