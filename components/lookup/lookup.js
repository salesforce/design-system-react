...
var Lookup = (0, _createReactClass2.default)({
   ...
   */
	...
	renderInput: function renderInput() {
		...
		return _react2.default.createElement(_input2.default, {
			...
			inputRef: function inputRef(component) {
				_this5.input = component;
				if (_this5.focusOnRender) {
					_this5.input.focus();
					_this5.focusOnRender = false;
				}
			},
			...
			_react2.default.createElement(
				'a',
				{
					...
					ref: function ref(pill) {
						_this6.pills[_this6.state.selectedIndex] = pill;
					},
	...
	render: function render() {
		...
		return _react2.default.createElement(
			'div',
			{ className: this.getClassName(), 'data-select': 'single', 'data-scope': 'single', onScroll: this.props.onScroll },
