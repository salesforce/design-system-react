...
function (_React$Component) {
  ...
  function Lookup() {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderInlineMenu", function () {
      return _this.getIsOpen() ? _react.default.createElement("div", {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderSeparateMenu", function () {
      ...
      return _this.getIsOpen() ? _react.default.createElement(_dialog.default, {
        align: "bottom",
    ...
    _defineProperty(_assertThisInitialized(_this), "renderSelectedItem", function () {
      ...
      var renderIcon = _this.props.iconName ? _react.default.createElement(_icon.default, {
      ...
      }, selectedItem), _react.default.createElement(_button.default, {
        assistiveText: {
    ...
    _defineProperty(_assertThisInitialized(_this), "renderLabel", function () {
      var inputLabel;
      var required = _this.props.required ? _react.default.createElement("span", {
        className: "slds-required"
      }, "*") : null;

      if (_this.isSelected()) {
        // inline style override
        inputLabel = _react.default.createElement("span", {
        ...
        inputLabel = _react.default.createElement("label", {
          className: "slds-form-element__label",
  ...
  _createClass(Lookup, [{
    ...
    value: function componentWillMount() {
      ...
      (0, _checkProps.default)(_constants.LOOKUP, this.props); // Keeps track of references of children for keyboard navigation
    ...
    value: function render() {
      ...
      }, this.props.label ? this.renderLabel() : null, _react.default.createElement("div", {
