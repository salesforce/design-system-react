...
var Lookup = (0, _createReactClass2.default)({
  ...
  renderInlineMenu: function renderInlineMenu() {
    return this.getIsOpen() ? _react2.default.createElement("div", {
  ...
  renderSeparateMenu: function renderSeparateMenu() {
    ...
    return this.getIsOpen() ? _react2.default.createElement(_dialog2.default, {
      align: "bottom",
  ...
  renderSelectedItem: function renderSelectedItem() {
    ...
    var labelClassName = this.props.iconName ? 'slds-pill__label' : 'slds-pill__label slds-m-left_x-small'; // i18n
  ...
  renderLabel: function renderLabel() {
    var inputLabel;
    var required = this.props.required ? _react2.default.createElement("span", {
