define(['module', 'react', 'prop-types', 'lodash.escaperegexp', 'lodash.isequal', './check-props', '../utilities/dialog', '../button', '../icon', '../icon/input-icon', '../forms/input', '../../utilities/event', '../../utilities/key-code', './menu', './menu/default-footer', './menu/default-header', './menu/default-section-divider', 'classnames', '../../utilities/constants'], function (module, _react, _propTypes, _lodash, _lodash3, _checkProps, _dialog, _button, _icon, _inputIcon, _input, _event, _keyCode, _menu, _defaultFooter, _defaultHeader, _defaultSectionDivider, _classnames, _constants) {
	'use strict';
