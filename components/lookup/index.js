define(['module', 'react', 'react-dom', 'lodash.escaperegexp', './check-props', '../utilities/dialog', '../button', '../icon', '../icon/input-icon', '../forms/input', '../../utilities/event', '../../utilities/keys', './menu', './menu/default-footer', './menu/default-header', './menu/default-section-divider', 'classnames', '../../utilities/constants'], function (module, _react, _reactDom, _lodash, _checkProps, _dialog, _button, _icon, _inputIcon, _input, _event, _keys, _menu, _defaultFooter, _defaultHeader, _defaultSectionDivider, _classnames, _constants) {
	'use strict';
