define(['module', 'react', 'react-dom', 'lodash.escaperegexp', './check-props', '../popover', '../button', '../icon', '../icon/input-icon', '../forms/input', '../../utilities', './menu', './menu/default-footer', './menu/default-header', './menu/default-section-divider', 'classnames', '../../utilities/constants'], function (module, _react, _reactDom, _lodash, _checkProps, _popover, _button, _icon, _inputIcon, _input, _utilities, _menu, _defaultFooter, _defaultHeader, _defaultSectionDivider, _classnames, _constants) {
	'use strict';
