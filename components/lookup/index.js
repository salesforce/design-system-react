define(['module', 'react', 'react-dom', 'lodash.escaperegexp', '../popover', '../button', '../icon', '../icon/input-icon', '../../utilities', './menu', './menu/default-footer', './menu/default-header', './menu/default-section-divider', 'classnames'], function (module, _react, _reactDom, _lodash, _popover, _button, _icon, _inputIcon, _utilities, _menu, _defaultFooter, _defaultHeader, _defaultSectionDivider, _classnames) {
	'use strict';
