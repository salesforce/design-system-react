define(['module', 'react', 'create-react-class', '@storybook/react', '../../icon-settings', '../../../utilities/constants', '../../lookup', '../../lookup/header', '../../lookup/footer', '../../button'], function (module, _react, _createReactClass, _react3, _iconSettings, _constants, _lookup, _header, _footer, _button) {
	'use strict';
	...
	var DemoLookup = (0, _createReactClass2.default)({
		...
		render: function render() {
			return _react2.default.createElement(
				...
				_react2.default.createElement(_lookup2.default, _extends({}, this.props, {
	...
	var DemoLookupAccounts = (0, _createReactClass2.default)({
		...
		getInitialState: function getInitialState() {
			return {
				options: [{ label: "Paddy's Pub", subTitle: 'Boston, MA' }, { label: 'Tyrell Corp', subTitle: 'San Francisco, CA' }, { label: 'Paper St. Soap Company', subTitle: 'Beloit, WI' }, { label: 'Nakatomi Investments', subTitle: 'Chicago, IL' }, { label: 'Acme Landscaping' }, { label: 'Acme Construction', subTitle: 'Grand Marais, MN' }]
			};
		},
		render: function render() {
	...
	(0, _react3.storiesOf)(_constants.LOOKUP, module).addDecorator(function (getStory) {
		...
		return _react2.default.createElement(DemoLookup, { disabled: true });
		...
		return _react2.default.createElement(DemoLookup, { emptyMessage: _react2.default.createElement(
				'span',
				null,
				'No matches.'
			), isInline: true });
