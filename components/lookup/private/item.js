define(['exports', 'react', 'prop-types', 'react-dom', '../../icon', '../../../utilities', 'lodash.escaperegexp', 'classnames'], function (exports, _react, _propTypes, _reactDom, _icon, _utilities, _lodash, _classnames) {
	'use strict';
