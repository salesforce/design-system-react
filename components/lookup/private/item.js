define(['exports', 'react', 'prop-types', '../../icon', '../../../utilities', 'classnames'], function (exports, _react, _propTypes, _icon, _utilities, _classnames) {
	'use strict';
		...
		_createClass(Item, [{
			...
			value: function render() {
				...
				return (
					...
					_react2.default.createElement(
						'li',
						{ className: itemClassName, ref: function ref(li) {
								_this2.itemRef = li;
							} },
						_react2.default.createElement(
							'a',
							{
								...
								onMouseDown: _utilities.EventUtil.trapImmediate,
								ref: id,
								role: 'option',
								tabIndex: '-1'
							},
