  ...
  _createClass(DataTableHeaderCell, [{
    ...
    value: function render() {
      ...
      var fixedLayoutSubRenders = {
        ...
        }, this.props.assistiveTextForColumnSort || this.props.assistiveText.columnSort, ' '), /*#__PURE__*/_react.default.createElement("span", {
        ...
        notSortable: /*#__PURE__*/_react.default.createElement("span", {
      ...
      var headerCellContent = this.props.fixedLayout ? fixedLayoutSubRenders[sortable ? 'sortable' : 'notSortable'] : /*#__PURE__*/_react.default.createElement("div", {
        className: "slds-truncate",
        title: labelType === 'string' ? label : undefined
      }, label);
      ...
      }, fixedHeader ? /*#__PURE__*/_react.default.cloneElement(headerCellContent, {
        style: {
          display: 'flex',
          height: 0,
          overflow: 'hidden',
      ...
      }) : headerCellContent, fixedHeader ? /*#__PURE__*/_react.default.createElement(_cellFixed.default, null, /*#__PURE__*/_react.default.cloneElement(headerCellContent, {
        style: {
          alignItems: 'center',
          display: 'flex',
          flex: '1 1 auto',
