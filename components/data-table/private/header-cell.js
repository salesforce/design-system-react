define(['exports', 'react', 'create-react-class', 'prop-types', 'classnames', 'lodash.isfunction', '../../icon', '../column-check-props', '../../../utilities/constants'], function (exports, _react, _createReactClass, _propTypes, _classnames, _lodash, _icon, _columnCheckProps, _constants) {
	'use strict';
