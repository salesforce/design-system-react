define(['exports', 'react', 'create-react-class', 'prop-types', 'classnames', 'lodash.find', '../../forms/checkbox', '../../../utilities/constants'], function (exports, _react, _createReactClass, _propTypes, _classnames, _lodash, _checkbox, _constants) {
	'use strict';
