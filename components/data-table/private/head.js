  ...
  function DataTableHead() {
    ...
    _defineProperty(_assertThisInitialized(_this), "getSelectHeader", function () {
      ...
      var getContent = function getContent(idSuffix, style) {
        return canSelectRows !== 'radio' ? _react.default.createElement("div", {
      ...
      if (canSelectRows) {
        selectHeader = _react.default.createElement("th", {
          ...
          paddingTop: 0,
          visibility: 'hidden'
        } : null), fixedHeader ? _react.default.createElement(_cellFixed.default, null, getContent('SelectAll-fixedHeader', {
          display: 'flex',
