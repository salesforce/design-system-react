  ...
  function DataTableHead() {
    ...
    _defineProperty(_assertThisInitialized(_this), "getActionsHeader", function () {
      ...
      if (_this.props.showRowActions) {
        ...
        /*#__PURE__*/
        _react.default.createElement(_cellFixed.default, null, getContent({
          lineHeight: 1,
          width: '100%'
        })) : null);
      }
    ...
    _defineProperty(_assertThisInitialized(_this), "getSelectHeader", function () {
      ...
      if (canSelectRows) {
        ...
        /*#__PURE__*/
        _react.default.createElement(_cellFixed.default, null, getContent('SelectAll', {
          display: 'flex',
    ...
    value: function render() {
      ...
      return (
        ...
        _react.default.createElement("tr", {
          ...
          return (
            /*#__PURE__*/
            _react.default.createElement(_headerCell.default, _extends({
