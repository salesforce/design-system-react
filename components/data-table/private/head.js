define(['exports', 'react', 'create-react-class', 'prop-types', '../../forms/checkbox', './header-cell', '../../../utilities/constants'], function (exports, _react, _createReactClass, _propTypes, _checkbox, _headerCell, _constants) {
	'use strict';
