...
var _fixedHeaderHorizontalScrolling = _interopRequireDefault(require("../__examples__/fixed-header-horizontal-scrolling"));

var _joinedWithPageHeader = _interopRequireDefault(require("../__examples__/joined-with-page-header"));
...
(0, _react2.storiesOf)(_constants.DATA_TABLE, module).addDecorator(function (getStory) {
  ...
  return _react.default.createElement(_fixedHeaderHorizontalScrolling.default, null);
}).add('Joined with Page Header', function () {
  return _react.default.createElement(_joinedWithPageHeader.default, null);
});