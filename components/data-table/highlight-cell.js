...
var DataTableHighlightCell = function DataTableHighlightCell(props) {
  return _react.default.createElement(_cell.default, props, _react.default.createElement(_highlighter.default, {
    search: props.search
  }, props.children));
}; // ### Display Name
...
DataTableHighlightCell.propTypes = {
   ...
   */
  children: _propTypes.default.oneOfType([_propTypes.default.string, _propTypes.default.number, _propTypes.default.bool]),
