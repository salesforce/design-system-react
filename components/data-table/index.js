...
var DataTable = /*#__PURE__*/function (_React$Component) {
    ...
    _defineProperty(_assertThisInitialized(_this), "repositionResizers", function () {
      ...
      if (_this.gripRefs) {
        _this.gripRefs.forEach(function (grip, index) {
          ...
          var newPosition = header.left + header.width - 30; // eslint-disable-next-line no-param-reassign
  ...
  _createClass(DataTable, [{
    ...
    value: function resizeGrips() {
      ...
      if (table) {
        var grips = table.getElementsByClassName('grip-handle');
    ...
    value: function enableResize() {
      ...
      if (_executionEnvironment.canUseDOM) {
        ...
        if (!this.resizer) {
          var options = _objectSpread(_objectSpread({}, defaultProps.resizableOptions), this.props.resizableOptions);
    ...
    value: function render() {
      ...
      _react.default.Children.forEach(this.props.children, function (child) {
        if (child && child.type.displayName === _column.default.displayName) {
          ...
          var props = (0, _lodash.default)({}, _this4.props); // eslint-disable-next-line fp/no-delete
      ...
      var tableContext = {
        ...
        setAllowKeyboardNavigation: function setAllowKeyboardNavigation(allowKeyboardNavigation) {
          if (_this4.getKeyboardNavigation()) {
            _this4.setState({
