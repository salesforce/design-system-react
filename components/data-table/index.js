...
var DataTable = (0, _createReactClass2.default)({
  ...
  handleToggleAll: function handleToggleAll(e, _ref) {
    ...
    if (typeof this.props.onRowChange === 'function') {
      var _selection = checked ? _toConsumableArray(this.props.items) : [];
  ...
  handleRowToggle: function handleRowToggle(item, selected, e) {
    ...
    if (typeof this.props.onRowChange === 'function') {
      ...
      if (selected) {
        _selection2 = _toConsumableArray(this.props.selection).concat([item]);
      } else {
        _selection2 = (0, _lodash4.default)(this.props.selection, item);
      }
