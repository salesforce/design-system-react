...
var document = !document ? null : document; // eslint-disable-line no-use-before-define

var window = !window ? null : window; // eslint-disable-line no-use-before-define
    ...
    Object.defineProperty(_assertThisInitialized(_this), "toggleFixedHeaderListeners", {
      ...
      value: function value(attach) {
        if (_this.props.onToggleFixedHeaderListeners) {
          ...
          if (_this.scrollerRef && _this.scrollerRef[action]) {
