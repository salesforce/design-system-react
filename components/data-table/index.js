define(['module', 'react', 'prop-types', 'shortid', 'classnames', 'lodash.assign', 'lodash.isarray', 'lodash.isfunction', 'lodash.reject', './check-props', './cell', './column', './private/head', './private/row', './row-actions', '../../utilities/constants'], function (module, _react, _propTypes, _shortid, _classnames, _lodash, _lodash3, _lodash5, _lodash7, _checkProps, _cell, _column, _head, _row, _rowActions, _constants) {
	'use strict';
