...
function (_React$Component) {
  ...
  function DataTable() {
    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_ref = DataTable.__proto__ || Object.getPrototypeOf(DataTable)).call.apply(_ref, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this), "handleToggleAll", {
      configurable: true,
      enumerable: true,
      writable: true,
      ...
      value: function value(item, selected, e) {
        ...
        if (typeof _this.props.onChange === 'function') {
          ...
          if (selected) {
            selection = _toConsumableArray(_this.props.selection).concat([item]);
          } else {
        ...
        if (typeof _this.props.onRowChange === 'function') {
          ...
          if (selected) {
            _selection2 = _toConsumableArray(_this.props.selection).concat([item]);
          } else {
  ...
  _createClass(DataTable, [{
    ...
    value: function render() {
      ...
      return _react2.default.createElement("table", {
        ...
        var rowId = "".concat(_this2.props.id, "-").concat(_constants.DATA_TABLE_ROW, "-").concat(item.id) || _shortid2.default.generate();
