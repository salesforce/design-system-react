		...
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(_column2.default, { label: 'Close Date', property: 'closeDate' }),
					_react2.default.createElement(_column2.default, { label: 'Stage', property: 'stage' }),
					_react2.default.createElement(_column2.default, {
					...
					_react2.default.createElement(_column2.default, { label: 'Amount', property: 'amount' }),
					_react2.default.createElement(
						_column2.default,
						{ label: 'Contact', property: 'contact' },
						_react2.default.createElement(CustomDataTableCell, null)
					),
