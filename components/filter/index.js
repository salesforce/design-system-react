...
function (_React$Component) {
  ...
  _createClass(Filter, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement("div", {
      ...
      }, !this.props.isLocked && (this.props.children || this.props.popover) ? _react.default.createElement(_popover.default, _extends({}, popoverProps, {
        ...
        className: "slds-assistive-text"
      }, assistiveText.editFilter), this.props.property ? _react.default.createElement("span", {
        className: "slds-show slds-text-body_small"
      }, this.props.property) : null, _react.default.createElement("span", {
        className: "slds-show"
      }, this.props.predicate))) : _react.default.createElement("button", {
        "aria-describedby": this.props.isError ? "".concat(this.getId(), "-error") : undefined,
        className: "slds-button_reset slds-grow slds-has-blur-focus",
        disabled: true,
        type: "button"
        ...
        className: "slds-show slds-text-body_small"
      }, this.props.property), _react.default.createElement("span", {
        className: "slds-show"
