define(['exports', 'react', 'create-react-class', 'prop-types', 'lodash.assign', 'classnames', '../button', '../popover', 'shortid', '../../utilities/constants'], function (exports, _react, _createReactClass, _propTypes, _lodash, _classnames, _button, _popover, _shortid, _constants) {
	'use strict';
