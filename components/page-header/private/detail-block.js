...
function (_Component) {
  ...
  _createClass(DetailBlock, [{
    ...
    value: function _getClassNames(className, flavor) {
      return (0, _classnames3.default)('slds-page-header__detail-block', className, _defineProperty({}, "slds-size_".concat(flavor), flavor));
    }
  }, {
    ...
    value: function render() {
      ...
      var renderContent = function renderContent() {
        ...
        if (type === 'string') {
          var labelClasses = (0, _classnames3.default)('slds-text-body_regular', {
            'slds-truncate': truncate
          });
          return _react2.default.createElement("p", {
