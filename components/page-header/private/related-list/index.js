...
function (_Component) {
  ...
  function RelatedList() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(RelatedList).apply(this, arguments));
  }
  ...
  _createClass(RelatedList, [{
    ...
    value: function render() {
      ...
      }, this.props.label, this.props.title), _react.default.createElement("div", {
        className: "slds-col slds-no-flex slds-grid slds-align-top"
      }, this.props.onRenderControls ? this.props.onRenderControls : this.props.navRight)), _react.default.createElement("div", {
        className: "slds-grid"
      }, _react.default.createElement("div", {
        className: "slds-col slds-align-bottom"
      }, this.props.info), _react.default.createElement("div", {
        className: "slds-col slds-no-flex slds-grid slds-align-bottom"
      }, this.props.onRenderActions ? this.props.onRenderActions : this.props.contentRight)));
    }
  }]);
