define(['module', 'react', 'prop-types', 'classnames', './private/info', './private/title', './private/detail-row', './private/detail-block', './private/base', './private/record-home', './private/object-home', '../icon', '../breadcrumb', '../../utilities/constants'], function (module, _react, _propTypes, _classnames, _info, _title, _detailRow, _detailBlock, _base, _recordHome, _objectHome, _icon, _breadcrumb, _constants) {
	'use strict';
