...
var _setup = _interopRequireDefault(require("../__examples__/setup"));
...
var recordHomeActions = function recordHomeActions() {
  return _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_control.default, null, _react.default.createElement(_buttonStateful.default, {
...
var baseControls = function baseControls() {
  return _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_control.default, null, _react.default.createElement(_button.default, {
    iconCategory: "utility",
    iconName: "settings",
    variant: "icon",
    iconVariant: "more",
...
(0, _react2.storiesOf)(_constants.PAGE_HEADER, module).addDecorator(function (getStory) {
  ...
  return _react.default.createElement(_setup.default, null);
});