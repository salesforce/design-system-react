define(['module', 'react', 'create-react-class', '@storybook/react', '../../../utilities/constants', '../../icon-settings', '../../page-header', '../../button-stateful', '../../button-group', '../../button', '../../menu-dropdown', '../../popover-tooltip', '../__examples__/object-home'], function (module, _react, _createReactClass, _react3, _constants, _iconSettings, _pageHeader, _buttonStateful, _buttonGroup, _button, _menuDropdown, _popoverTooltip, _objectHome) {
	...
	var recordHomeDetails1 = [{
		...
		flavor: '1-of-4',
		truncate: true
	}, { label: 'Field 2', content: 'Multiple Values' }, { label: 'Field 3', content: 'Description (2-line truncation)' }];
	...
	var recordHomeContentRight = _react2.default.createElement(
		...
		_react2.default.createElement(
			...
			_react2.default.createElement(_button2.default, { label: 'Delete' }),
			_react2.default.createElement(_button2.default, { label: 'Clone' }),
	...
	var recordHomeDetails = [{
		...
		flavor: '1-of-4',
		truncate: true
	}, { label: 'Field 2', content: 'Multiple Values' }, { label: 'Field 3', content: customTooltip(), flavor: '1-of-4' }, { label: 'Field 4', content: 'Description (2-line truncation)' }];
	...
	var objectHomeNavRight = _react2.default.createElement(
		_buttonGroup2.default,
		null,
		_react2.default.createElement(_button2.default, { label: 'New Lead', variant: 'neutral' }),
		_react2.default.createElement(_menuDropdown2.default, {
			align: 'right',
			assistiveText: 'More Options',
			iconName: 'down',
	...
	var relatedListNavRight = _react2.default.createElement(
		_buttonGroup2.default,
		null,
		_react2.default.createElement(_button2.default, { label: 'Add Contact', variant: 'neutral' }),
		_react2.default.createElement(_menuDropdown2.default, {
			assistiveText: 'More Options',
			buttonVariant: 'icon',
			iconName: 'down',
