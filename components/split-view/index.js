define(['exports', 'react', 'prop-types', 'shortid', 'classnames', 'lodash.isboolean', './private/toggle-button', '../../utilities/constants'], function (exports, _react, _propTypes, _shortid, _classnames, _lodash, _toggleButton, _constants) {
	'use strict';
   ...
   */
		master: _propTypes2.default.arrayOf(_propTypes2.default.element).isRequired,
		/**
	...
	var SplitView = function (_React$Component) {
		...
		_createClass(SplitView, [{
			...
			value: function toggle(event) {
				...
				this.state.isOpen ? this.props.events.onClose && this.props.events.onClose(event) : this.props.events.onOpen && this.props.events.onOpen(event);
			}
		}, {
			key: 'masterContent',
