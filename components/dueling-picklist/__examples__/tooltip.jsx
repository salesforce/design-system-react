...
const ids = {
	picklistGroupLabel: 'picklist-label-9',
	dragLiveRegion: 'drag-live-region-9',
	optionDragLabel: 'option-drag-label-9',
	optionsLabel: 'options-label-9',
	selectedLabel: 'selected-label-9',
};
