...
const ids = {
	picklistGroupLabel: 'picklist-label-3',
	dragLiveRegion: 'drag-live-region-3',
	optionDragLabel: 'option-drag-label-3',
	optionsLabel: 'options-label-3',
	selectedLabel: 'selected-label-3',
};
