...
function (_React$Component) {
  ...
  function ScopedNotification(props) {
    ...
    (0, _checkProps.default)(_constants.SCOPED_NOTIFICATION, props, _docs.default);
    return _this;
  }
  ...
  _createClass(ScopedNotification, [{
    ...
    value: function render() {
      ...
      if (this.props.icon) {
        ...
        icon = _react.default.cloneElement(this.props.icon, _objectSpread({}, this.props.icon.props, {
