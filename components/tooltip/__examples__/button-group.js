		...
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				...
				_react2.default.createElement(
					...
					{ align: 'bottom', content: 'Buttonbar Tooltip' },
					_react2.default.createElement(_button2.default, { label: 'Refresh' })
				),
				_react2.default.createElement(
					_popoverTooltip2.default,
					{ align: 'bottom right', content: 'Buttonbar Tooltip' },
				...
				_react2.default.createElement(_menuDropdown2.default, {
					...
					options: [{ label: 'A Option', value: 'A0' }, { label: 'B Option', value: 'B0' }, { label: 'C Option', value: 'C0' }]
				})
			)
		);
	}
