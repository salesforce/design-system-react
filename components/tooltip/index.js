...
function (_React$Component) {
  ...
  _createClass(Tooltip, [{
    ...
    value: function componentWillMount() {
      ...
      (0, _checkProps2.default)(_constants.POPOVER_TOOLTIP, this.props, _docs2.default);
    ...
    value: function getContent() {
      ...
      var children;
      var noChildrenProvided = _react2.default.Children.count(this.props.children) === 0;
    ...
    value: function getTooltip() {
      ...
      return isOpen ? _react2.default.createElement(_dialog2.default, {
        closeOnTabKey: true,
        hasNubbin: true,
        contentsClassName: (0, _classnames2.default)('slds-popover', 'slds-popover_tooltip', {
    ...
    value: function getTooltipContent() {
      ...
      }, this.props.content, this.props.variant === 'learnMore' && this.props.onClickTrigger ? _react2.default.createElement("div", {
