  ...
  _createClass(Tooltip, [{
    ...
    value: function getAnchoredNubbinStyles() {
      if (this.props.hasAnchoredNubbin) {
        ...
        return _react.default.createElement(_react.default.Fragment, null, _react.default.createElement("style", null, "#".concat(this.getId(), ":after, #").concat(this.getId(), ":before {\n\tdisplay: none;\n}")), this.getIsOpen() ? _react.default.createElement("div", {
