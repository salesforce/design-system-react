define(['exports', 'react', 'prop-types', 'classnames', 'lodash.flatten', 'lodash.compact', 'shortid', '../../utilities/constants', '../utilities/dialog', '../../utilities/dialog-helpers', './check-props'], function (exports, _react, _propTypes, _classnames, _lodash, _lodash3, _shortid, _constants, _dialog, _dialogHelpers, _checkProps) {
	'use strict';
