...
function (_React$Component) {
  ...
  _createClass(WelcomeMat, [{
    ...
    value: function render() {
      ...
      var splash = _react.default.createElement("div", {
      ...
      }, this.props.labels.title), _react.default.createElement("div", {
        className: "slds-welcome-mat__info-description slds-text-longform"
      }, _react.default.createElement("p", null, this.props.labels.description)), this.props.variant === 'info-only' || this.props.variant === 'splash' ? _react.default.createElement("div", {
        className: "slds-welcome-mat__info-actions"
      }, this.props.onRenderInfoActions() ? this.props.onRenderInfoActions() : null, _react.default.createElement("div", {
        className: "slds-m-top_large"
      }, this.props.doNotShowAgainCheckbox ? this.props.doNotShowAgainCheckbox : null)) : null, (this.props.variant === 'steps' || this.props.variant === 'trailhead-connected') && this.props.children ? _react.default.createElement(_react.default.Fragment, null, _react.default.createElement("div", {
      ...
      }) : null, this.state.completedSteps !== this.state.totalSteps || this.props.variant !== 'trailhead-connected' ? _react.default.createElement(_react.default.Fragment, null, this.props.variant === 'trailhead-connected' ? _react.default.createElement("p", null, this.state.completedSteps, "/", this.state.totalSteps, " units completed") : _react.default.createElement("p", null, _react.default.createElement("strong", null, this.state.completedSteps, "/", this.state.totalSteps, ' ', "units completed")), _react.default.createElement(_progressBar.default, {
      ...
      return _react.default.createElement(_modal.default, {
        ...
        className: (0, _classnames.default)('slds-welcome-mat', this.props.children ? null : 'slds-welcome-mat_splash'),
        id: this.getId()
      }, _react.default.createElement("div", {
        className: "slds-welcome-mat__content slds-grid"
      }, this.props.children ? _react.default.createElement(_react.default.Fragment, null, _react.default.createElement("div", {
        className: "slds-welcome-mat__info slds-size_1-of-2"
      }, splash), _react.default.createElement("div", {
