...
function (_React$Component) {
  ...
  _createClass(WelcomeMat, [{
    ...
    value: function render() {
      ...
      }, labels.title), _react.default.createElement("div", {
        className: "slds-welcome-mat__info-description slds-text-longform"
      }, _react.default.createElement("p", null, labels.description)), this.props.variant === 'info-only' || this.props.variant === 'splash' ? _react.default.createElement("div", {
