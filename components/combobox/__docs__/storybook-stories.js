...
var _baseMenuItemDisabledTooltipOpen = require("../__examples__/base-menu-item-disabled-tooltip-open");

var _baseMenuItemDisabledTooltipOpen2 = _interopRequireDefault(_baseMenuItemDisabledTooltipOpen);
...
var _readonlySingleDisabled = require("../__examples__/readonly-single-disabled");

var _readonlySingleDisabled2 = _interopRequireDefault(_readonlySingleDisabled);
...
var _inputProp = require("../__examples__/input-prop");

var _inputProp2 = _interopRequireDefault(_inputProp);
...
var _readonlySingleSelectionDisabled = require("../__examples__/snapshot/readonly-single-selection-disabled");

var _readonlySingleSelectionDisabled2 = _interopRequireDefault(_readonlySingleSelectionDisabled);
...
(0, _react3.storiesOf)(_constants.COMBOBOX, module).addDecorator(function (getStory) {
  ...
  return _react2.default.createElement(_baseMenuItemDisabledTooltipOpen2.default, {
    action: _addonActions.action
  });
  ...
  return _react2.default.createElement(_readonlySingleDisabled2.default, {
    action: _addonActions.action
  });
  ...
  return _react2.default.createElement(_inputProp2.default, {
    action: _addonActions.action
  });
  ...
  return _react2.default.createElement(_readonlySingleSelectionDisabled2.default, {
    action: _addonActions.action
  });
