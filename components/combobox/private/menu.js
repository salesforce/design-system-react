...
var Menu = function Menu(props) {
	var menuOptions = props.options.map(function (optionData, index) {
		...
		var selected = props.isSelected({ selection: props.selection, option: optionData });
		...
		return _react2.default.createElement(
			...
			},
			{
				'icon-title-subtitle': _react2.default.createElement(
					...
					optionData.icon ? _react2.default.createElement(
						'span',
	...
	return _react2.default.createElement(
		'div',
		{ id: props.inputId + '-listbox', role: 'listbox' },
		_react2.default.createElement(
			'ul',
			{
