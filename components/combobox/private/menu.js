...
var setBold = function setBold(label, searchTerm) {
  ...
  if (position > -1) {
    return (
      /*#__PURE__*/
      _react.default.createElement(_react.default.Fragment, null, label.substr(0, position),
      /*#__PURE__*/
...
var Menu = function Menu(props) {
  ...
  var menuOptions = getOptions(props).map(function (optionData, index) {
    ...
    if (optionData.disabled && props.tooltipMenuItemDisabled) {
      ...
      item =
      /*#__PURE__*/
      _react.default.cloneElement(props.tooltipMenuItemDisabled, tooltipProps, menuItem[props.variant]);
    } else {
