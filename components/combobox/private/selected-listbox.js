define(['exports', 'react', 'prop-types', '../../utilities/pill', 'classnames', 'lodash.isequal', 'airbnb-prop-types'], function (exports, _react, _propTypes, _pill, _classnames, _lodash, _airbnbPropTypes) {
	'use strict';
						...
						_react2.default.createElement(_pill2.default, {
							...
							events: {
								...
								onClick: function onClick(event, data) {
									props.events.onClickPill(event, _extends({}, data, { index: renderIndex }));
								},
								...
								onRequestRemove: function onRequestRemove(event, data) {
									props.events.onRequestRemove(event, _extends({}, data, { index: renderIndex }));
								},
