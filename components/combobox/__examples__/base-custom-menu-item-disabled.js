...
var CustomMenuItem = function CustomMenuItem(props) {
  ...
  return _react2.default.createElement("span", null, _react2.default.createElement("span", {
    className: (0, _classnames2.default)('slds-listbox__option-text', 'slds-listbox__option-text_entity', disabledRule)
  }, props.option.label), _react2.default.createElement("span", {
    className: (0, _classnames2.default)('slds-listbox__option-meta', 'slds-listbox__option-meta_entity', disabledRule)
