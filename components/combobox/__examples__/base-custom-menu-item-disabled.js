...
var CustomMenuItem = function CustomMenuItem(props) {
  ...
  return _react.default.createElement("span", null, _react.default.createElement("span", {
    className: (0, _classnames.default)('slds-listbox__option-text', 'slds-listbox__option-text_entity', disabledRule)
  }, props.option.label), _react.default.createElement("span", {
    className: (0, _classnames.default)('slds-listbox__option-meta', 'slds-listbox__option-meta_entity', disabledRule)
