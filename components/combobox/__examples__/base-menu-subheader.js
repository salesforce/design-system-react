...
var _addSubheadings = _interopRequireDefault(require("../../../../components/combobox/add-subheadings"));
  ...
  _createClass(Example, [{
    ...
    value: function render() {
      ...
      return _react.default.createElement(_iconSettings.default, {
        ...
        multiple: true,
        options: (0, _addSubheadings.default)({
          subheadings: subheadings,
          filteredOptions: (0, _filter.default)({
