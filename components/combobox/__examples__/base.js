define(['exports', 'react', '../../../../components/combobox', '../../../../components/icon', '../../../../components/combobox/filter', '../../../../components/icon-settings'], function (exports, _react, _combobox, _icon, _filter, _iconSettings) {
	...
	var accounts = [{
		...
		type: 'account'
	}, { id: '7', label: 'Acme Landscaping', subTitle: '\xA0', type: 'account' }, {
		id: '8',
	...
	var accountsWithIcon = accounts.map(function (elem) {
		return Object.assign(elem, {
			icon: _react2.default.createElement(_icon2.default, { assistiveText: 'Account', category: 'standard', name: elem.type })
		});
	});
