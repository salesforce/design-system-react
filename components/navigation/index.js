define(['exports', 'react', 'create-react-class', 'prop-types', 'classnames', 'shortid', '../../utilities/constants', './private/item'], function (exports, _react, _createReactClass, _propTypes, _classnames, _shortid, _constants, _item) {
	'use strict';
