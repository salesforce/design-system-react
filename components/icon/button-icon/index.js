define(['exports', 'react', 'prop-types', 'classnames', './check-props', '../../utilities/utility-icon', '../../../utilities/constants'], function (exports, _react, _propTypes, _classnames, _checkProps, _utilityIcon, _constants) {
	'use strict';
