define(['module', 'react', 'prop-types', '../../utilities/class-names', '../utilities/utility-icon', '../../utilities/constants'], function (module, _react, _propTypes, _classNames2, _utilityIcon, _constants) {
	'use strict';
