define(['module', 'react', 'prop-types', 'classnames', 'lodash.isfunction', '../../utilities/utility-icon', '../../button', '../../../utilities/constants'], function (module, _react, _propTypes, _classnames, _lodash, _utilityIcon, _button, _constants) {
	'use strict';
