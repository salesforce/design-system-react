...
var _productThemes = _interopRequireDefault(require("../__examples__/product-themes.jsx"));
...
(0, _react2.storiesOf)(_constants.ICON, module).addDecorator(function (getStory) {
  ...
  return makeRtl(_react.default.createElement(_standard.default, null));
  ...
  return _react.default.createElement(_productThemes.default, null);
