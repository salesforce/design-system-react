...
var _colorLight = require("../__examples__/color-light");
...
var _categories = require("../__examples__/categories");

var _categories2 = _interopRequireDefault(_categories);

var _colors = require("../__examples__/colors");
...
(0, _react3.storiesOf)(_constants.ICON, module).addDecorator(function (getStory) {
  ...
  return _react2.default.createElement(_colorError2.default, null);
}).add('Color: Warning', function () {
  return _react2.default.createElement(_colorWarning2.default, null);
}).add('Color: Light', function () {
  return _react2.default.createElement(_colorLight2.default, null);
