...
var renderSecondary = function renderSecondary(dividerClass, className, children, navigation) {
  ...
  if (navigation) {
    region = _react2.default.createElement("nav", {
    ...
    region = _react2.default.createElement("div", {
      className: (0, _classnames2.default)('slds-context-bar__secondary', dividerClass, className)
    }, _react2.default.createElement("ul", {
      className: "slds-grid"
    }, children));
...
var renderTertiary = function renderTertiary(dividerClass, className, children) {
  return _react2.default.createElement("div", {
    className: (0, _classnames2.default)('slds-context-bar__tertiary', 'slds-col_bump-left', dividerClass, className)
  }, _react2.default.createElement("ul", {
    className: "slds-grid"
  }, children));
};
...
Object.defineProperty(Region, "displayName", {
  configurable: true,
  enumerable: true,
  writable: true,
  value: _constants.GLOBAL_NAVIGATION_BAR_REGION
});
Object.defineProperty(Region, "propTypes", {
  configurable: true,
  enumerable: true,
  writable: true,
  value: {
