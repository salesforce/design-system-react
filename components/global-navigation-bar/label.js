...
var GlobalNavigationBarLabel = function GlobalNavigationBarLabel(props) {
  ...
  return _react2.default.createElement("li", {
    ...
    ,
    style: {
      color: _salesforceSkinCommon2.default.colorTextLinkDisabled
    },
    className: (0, _classnames2.default)('slds-context-bar__label-action', _defineProperty({}, "slds-context-bar__item_divider-".concat(dividerPosition), dividerPosition), className)
  }, _react2.default.createElement("span", {
