...
var GlobalNavigationBar = function GlobalNavigationBar(props) {
  ...
  return _react2.default.createElement("div", {
    className: (0, _classnames2.default)('slds-context-bar', (_classNames = {}, _defineProperty(_classNames, "slds-context-bar--theme-".concat(props.cloud), props.cloud), _defineProperty(_classNames, "slds-context-bar--theme-".concat(props.theme), props.theme), _classNames), props.className)
