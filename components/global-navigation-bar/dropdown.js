...
var GlobalNavigationBarDropdown = function GlobalNavigationBarDropdown(props) {
  (0, _checkProps.default)(_constants.GLOBAL_NAVIGATION_BAR_DROPDOWN, props, _docs.default); // Separate props we care about in order to pass others along passively to the dropdown component
  ...
  return _react.default.createElement(_menuDropdown.default, _extends({
    align: "right",
  ...
  }, rest), _react.default.createElement(_dropdownTrigger.default, {
    active: active,
