...
var GlobalNavigationBarDropdown = function GlobalNavigationBarDropdown(props) {
  (0, _checkProps2.default)(_constants.GLOBAL_NAVIGATION_BAR_DROPDOWN, props, _docs2.default); // Separate props we care about in order to pass others along passively to the dropdown component
