   ...
   */
    ...
    */
		...
		render: function render() {
			...
			var rest = _objectWithoutProperties(_props, ['active', 'activeBackgroundColor', 'className', 'dividerPosition', 'id', 'isOpen', 'label', 'menu', 'onBlur', 'onClick', 'onFocus', 'onKeyDown', 'onMouseDown', 'triggerRef']);
