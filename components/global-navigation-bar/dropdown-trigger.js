   ...
   */
    ...
    */
		...
		render: function render() {
			...
			var rest = _objectWithoutProperties(_props, ['active', 'activeBackgroundColor', 'className', 'dividerPosition', 'id', 'isOpen', 'label', 'menu', 'onBlur', 'onClick', 'onFocus', 'onKeyDown', 'onMouseDown', 'onMouseEnter', 'onMouseLeave', 'triggerRef']);
			...
			return _react2.default.createElement(
				...
				{
					'aria-haspopup': 'true',
					className: (0, _classnames2.default)('slds-context-bar__item slds-context-bar-action slds-dropdown-trigger slds-dropdown-trigger--click', _defineProperty({
						'slds-is-open': isOpen,
