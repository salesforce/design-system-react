define(['exports', 'react', 'prop-types', '../../utilities/class-names', '../../utilities/constants', '../icon'], function (exports, _react, _propTypes, _classNames, _constants, _icon) {
	'use strict';
	...
	var Avatar = function (_React$Component) {
		...
		_createClass(Avatar, [{
			...
			value: function renderBaseAvatar() {
				...
				return _react2.default.createElement('img', { alt: imgAlt, src: imgSrc, onError: function onError() {
