...
function (_React$Component) {
  ...
  _createClass(Example, [{
    ...
    value: function render() {
      return _react.default.createElement(_iconSettings.default, {
      ...
      }, _react.default.createElement(_buttonGroup.default, null, _react.default.createElement(_buttonStateful.default, {
        assistiveText: {
          icon: 'Show Chart'
        },
        buttonVariant: "icon",
        ...
        iconVariant: "border",
        variant: "icon"
      }), _react.default.createElement(_buttonStateful.default, {
        assistiveText: {
          icon: 'Filter List'
        },
        iconName: "filterList",
