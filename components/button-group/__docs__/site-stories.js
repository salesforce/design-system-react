define(['module', 'raw-loader!design-system-react/components/button-group/__examples__/more-icon.jsx', 'raw-loader!design-system-react/components/button-group/__examples__/icon-group.jsx'], function (module) {
	'use strict';
