define(['module', 'react', 'prop-types', 'classnames', 'lodash.assign', 'airbnb-prop-types', '../../utilities/constants'], function (module, _react, _propTypes, _classnames, _lodash, _airbnbPropTypes, _constants) {
	'use strict';
