...
function (_React$Component) {
  ...
  function ExpressionGroup() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(ExpressionGroup).apply(this, arguments));
  }
  ...
  _createClass(ExpressionGroup, [{
    ...
    value: function render() {
      ...
      var triggerCombobox = _react.default.createElement(_combobox.default, {
        events: {
          onSelect: function onSelect(event, data) {
            return _this.props.events.onChangeTrigger(event, {
      ...
      var buttons = this.props.triggerType !== 'always' && this.props.triggerType !== 'formula' ? _react.default.createElement("div", {
      ...
      }), this.props.isRoot ? _react.default.createElement(_button.default, {
        iconCategory: "utility",
        iconName: "add",
        iconPosition: "left",
      ...
      var body = this.props.triggerType !== 'always' ? _react.default.createElement(_react.default.Fragment, null, this.props.triggerType === 'custom' ? _react.default.createElement(_input.default, {
      ...
      }) : null, _react.default.createElement("ul", null, this.props.children)) : null;
      return !this.props.isRoot ? _react.default.createElement("li", {
      ...
      }, assistiveText.label)), _react.default.createElement("div", {
        className: "slds-expression__options"
      }, triggerCombobox), _react.default.createElement("ul", null, body), buttons)) : _react.default.createElement("div", {
