    ...
    value: function render() {
      ...
      if (this.props.triggerType !== 'always') {
        if (this.props.isRoot && this.props.triggerType === 'formula') {
          ...
          body = _react.default.createElement(_react.default.Fragment, null, this.props.triggerType === 'custom' ? _react.default.createElement(_input.default, {
          ...
          }) : null, _react.default.createElement("ul", null, this.props.children));
        }
      }
