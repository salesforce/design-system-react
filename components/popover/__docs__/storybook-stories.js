define(['module', 'react', '@storybook/react', '@storybook/addon-actions', '../../icon-settings', '../../../utilities/constants', '../__examples__/header', '../__examples__/alternative-header', '../__examples__/controlled-with-footer', '../../popover', '../../button'], function (module, _react, _react3, _addonActions, _iconSettings, _constants, _header, _alternativeHeader, _controlledWithFooter, _popover, _button) {
	'use strict';
	...
	var getPopoverNubbins = function getPopoverNubbins(props) {
		...
		align.forEach(function (value) {
			children.push(_react2.default.createElement(
				'div',
				{ key: value, style: { margin: '150px auto' } },
				_react2.default.createElement(
					_popover2.default,
					_extends({
						align: value,
	...
	(0, _react3.storiesOf)(_constants.POPOVER, module).addDecorator(function (getStory) {
		...
		return _react2.default.createElement(_controlledWithFooter2.default, { log: _addonActions.action });
		...
		return getPopoverNubbins({
			trigger: _react2.default.createElement(_button2.default, { label: 'Trigger Popover', tabIndex: '0' })
		});
