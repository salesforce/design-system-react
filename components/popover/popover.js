    ...
    return _possibleConstructorReturn(_this, (_temp = _this = _possibleConstructorReturn(this, (_ref = Popover.__proto__ || Object.getPrototypeOf(Popover)).call.apply(_ref, [this].concat(args))), Object.defineProperty(_assertThisInitialized(_this), "state", {
      ...
      value: function value(isOpen, outsideClickIgnoreClass) {
        ...
        return isOpen ? _react2.default.createElement(_dialog2.default, {
          hasNubbin: true,
          align: props.align,
          contentsClassName: (0, _classnames2.default)(_this.props.contentsClassName, 'ignore-react-onclickoutside', 'slds-popover', {
        ...
        }), hasDefinedHeader ? headerVariants[hasThemedHeader ? 'themed' : 'base'] : null, props.variant === 'error' || props.variant === 'warning' ? // THIS WRAPPING DIV IS NOT IN SLDS MARKUP
        _react2.default.createElement("div", null, _react2.default.createElement("div", {
          id: "".concat(_this.getId(), "-dialog-body"),
          className: "slds-popover__body slds-popover__body_scrollable" // REMOVE IN THE FUTURE: SLDS OVERRIDE
          // Possible solution in future is to use .slds-popover__body_small
          ,
          style: {
            borderBottom: 'none'
          }
        }, props.body), _react2.default.createElement("div", {
        ...
        _react2.default.createElement("div", {
          id: "".concat(_this.getId(), "-dialog-body"),
          className: (0, _classnames2.default)('slds-popover__body', {
            'slds-popover__body_scrollable': props.variant === 'error' || props.variant === 'warning'
          })
...
Object.defineProperty(Popover, "propTypes", {
  ...
  value: {
     ...
     */
    variant: _propTypes2.default.oneOf(['base', 'error', 'warning'])
  }
});
