    ...
    _defineProperty(_assertThisInitialized(_this), "renderDialog", function (isOpen, outsideClickIgnoreClass) {
      ...
      if (props.footer) {
        footer = _react.default.createElement("footer", {
          className: (0, _classnames.default)('slds-popover__footer', _this.props.footerClassName)
        }, _this.props.footer);
...
_defineProperty(Popover, "propTypes", {
   ...
   */
  footerClassName: _propTypes.default.oneOfType([_propTypes.default.array, _propTypes.default.object, _propTypes.default.string]),
