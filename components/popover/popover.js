define(['module', 'react', 'prop-types', 'lodash.assign', 'classnames', 'lodash.isboolean', 'lodash.isfunction', './check-props', 'shortid', '../button', '../utilities/dialog', '../../utilities/dialog-helpers', '../../utilities/keyboard-navigable-dialog', '../iconSettings', '../../utilities/key-code', '../../utilities/constants'], function (module, _react, _propTypes, _lodash, _classnames, _lodash3, _lodash5, _checkProps, _shortid, _button, _dialog, _dialogHelpers, _keyboardNavigableDialog, _iconSettings, _keyCode, _constants) {
	'use strict';
