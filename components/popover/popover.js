    ...
    _defineProperty(_assertThisInitialized(_this), "renderDialog", function (isOpen, outsideClickIgnoreClass) {
      ...
      if (props.variant === 'error' || props.variant === 'warning') {
        ...
        _react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("div", {
          ...
          className: (0, _classnames.default)('slds-popover__body', _this.props.classNameBody) // REMOVE IN THE FUTURE: SLDS OVERRIDE
          // Possible solution in future is to use .slds-popover__body_small
          ,
          style: {
            borderBottom: 'none'
          }
        }, props.body), /*#__PURE__*/_react.default.createElement("div", {
