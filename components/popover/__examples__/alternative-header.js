define(['exports', 'react', 'create-react-class', '../../../../components/icon-settings', '../../../../components/popover', '../../../../components/button', '../../../../components/icon'], function (exports, _react, _createReactClass, _iconSettings, _popover, _button, _icon) {
	'use strict';
			...
			_react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							'p',
							{ id: 'ALTERNATIVE-HEADING', className: 'slds-text-heading--small slds-hyphenate' },
							'Opportunities (1+)'
						)
					)
				)
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'p',
								{ className: 'slds-truncate', title: 'Value' },
								'Value'
							)
						),
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'p',
								{ className: 'slds-truncate', title: '$500,000' },
								'$500,000'
							)
						),
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'p',
								{ className: 'slds-truncate', title: 'Close Date' },
								'Close Date'
							)
						),
						_react2.default.createElement(
							...
							_react2.default.createElement(
								'p',
								{ className: 'slds-truncate', title: 'Dec 15, 2015' },
								'Dec 15, 2015'
							)
						)
					)
