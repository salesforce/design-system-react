define(['exports', 'react', 'prop-types', 'classnames', 'airbnb-prop-types', '../../utilities/constants', '../utilities/utility-icon', '../../utilities/key-code', '../../utilities/event', './check-props'], function (exports, _react, _propTypes, _classnames, _airbnbPropTypes, _constants, _utilityIcon, _keyCode, _event, _checkProps) {
	'use strict';
	...
	var Pill = function (_React$Component) {
		...
		function Pill() {
			...
			return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Pill.__proto__ || Object.getPrototypeOf(Pill)).call.apply(_ref, [this].concat(args))), _this), _this.getHref = function () {
				return typeof _this.props.href === 'string' ? _this.props.href : 'javascript:void(0);' // eslint-disable-line no-script-url
				;
