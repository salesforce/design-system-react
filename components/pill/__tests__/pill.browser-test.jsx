...
import SLDSListboxOfPillOptions from '~/components/pill/listbox-of-pill-options';
...
describe.only('SLDSPill', () => {
	...
	describe.only('Listbox of Pill Options', () => {
		...
		it('Renders the Listbox of Pill Options correctly', function() {
			let currentPill = 1;
