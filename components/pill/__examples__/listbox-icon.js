define(['exports', 'react', 'create-react-class', '../../../../components/pill', '../../../../components/icon', '../../../../components/icon-settings'], function (exports, _react, _createReactClass, _pill, _icon, _iconSettings) {
	'use strict';
	...
	var Example = (0, _createReactClass2.default)({
		...
		renderListItem: function renderListItem(icon, index) {
			...
			if (this.state['pill' + index]) {
				return _react2.default.createElement(
					'li',
					{ className: 'slds-listbox-item', role: 'presentation', key: index },
					_react2.default.createElement(_pill2.default, {
						...
						variant: 'option',
						icon: _react2.default.createElement(_icon2.default, { title: 'Title', category: icon.category, name: icon.name }),
