define(['module', 'react', 'prop-types', 'classnames', 'lodash.isboolean', 'lodash.isfunction', 'lodash.omit', '../icon/button-icon', '../popover-tooltip/trigger', '../../utilities/constants'], function (module, _react, _propTypes, _classnames, _lodash, _lodash3, _lodash5, _buttonIcon, _trigger, _constants) {
	'use strict';
