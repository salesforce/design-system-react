define(['exports', 'react', 'prop-types', 'classnames', 'lodash.isboolean', 'lodash.isfunction', '../icon/button-icon', '../popover-tooltip/trigger', '../../utilities/constants'], function (exports, _react, _propTypes, _classnames, _lodash, _lodash3, _buttonIcon, _trigger, _constants) {
	'use strict';
