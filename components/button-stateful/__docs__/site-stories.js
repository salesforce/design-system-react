...
var siteStories = [require('raw-loader!design-system-react/components/button-stateful/__examples__/icon.jsx'), require('raw-loader!design-system-react/components/button-stateful/__examples__/icon-text.jsx')];
