define(['module', 'raw-loader!design-system-react/components/button-stateful/__examples__/icon.jsx', 'raw-loader!design-system-react/components/button-stateful/__examples__/icon-text.jsx'], function (module) {
	'use strict';
