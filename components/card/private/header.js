...
var renderFilter = function renderFilter(filter, id) {
  ...
  var clonedFilter = _react.default.cloneElement(filter, {
...
var CardHeader = function CardHeader(props) {
  ...
  var heading = _react.default.createElement("h2", {
    id: props.headingId,
  ...
  if (props.header) {
    Header = _react.default.cloneElement(props.header, _objectSpread({
      figure: props.icon,
      body: heading,
      verticalCenter: true,
      canTruncate: true
  ...
  }, Header, props.filter ? renderFilter(props.filter, props.filterId) : null, _react.default.createElement("div", {
