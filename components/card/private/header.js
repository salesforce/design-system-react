...
var CardHeader = function CardHeader(props) {
  ...
  var heading = _react2.default.createElement("h2", {
    id: props.headingId,
  ...
  if (props.header) {
    Header = _react2.default.cloneElement(props.header, _objectSpread({
      figure: props.icon,
      body: heading,
      verticalCenter: true,
      canTruncate: true
  ...
  }, Header, props.filter ? renderFilter(props.filter, props.filterId) : null, _react2.default.createElement("div", {
