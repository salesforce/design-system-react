			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					_card2.default,
					{
						...
						}) : _react2.default.createElement(_button2.default, { label: 'New', onClick: this.handleAddItem }),
						footer: 'Card Footer',
						heading: heading,
					...
					_react2.default.createElement(
						_dataTable2.default,
						{ id: 'SLDSDataTableExample-1', items: items, bordered: true },
						_react2.default.createElement(
							_column2.default,
							{ label: 'Opportunity Name', property: 'name', truncate: true },
