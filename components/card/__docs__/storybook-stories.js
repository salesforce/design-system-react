define(['module', 'react', 'create-react-class', 'prop-types', 'lodash.uniqueid', '@storybook/react', '../../icon-settings', '../../../utilities/constants', '../../button', '../../card', '../../card/empty', '../../card/filter', '../../data-table', '../../data-table/column', '../../data-table/highlight-cell', '../../icon', '../../media-object', '../../forms/input/inline'], function (module, _react, _createReactClass, _propTypes, _lodash, _react3, _iconSettings, _constants, _button, _card, _empty, _filter, _dataTable, _column, _highlightCell, _icon, _mediaObject, _inline) {
	'use strict';
	...
	var DemoCard = (0, _createReactClass2.default)({
		...
		render: function render() {
			...
			if (!this.props.heading) {
				heading = items.length > 0 ? 'Related Items (' + items.length + ')' : 'Related Items';
			}
			...
			return _react2.default.createElement(
				...
				_react2.default.createElement(
					...
					{
						id: 'ExampleCard',
						filter: !isEmpty || this.state.filter ? _react2.default.createElement(_filter2.default, { onChange: this.handleFilterChange }) : null,
						header: this.props.header,
						headerActions: !isEmpty ? _react2.default.createElement(_button2.default, { label: 'Delete All Items', onClick: this.handleDeleteAllItems }) : _react2.default.createElement(_button2.default, { label: 'New', onClick: this.handleAddItem }),
						footer: 'Card Footer',
						heading: heading,
						icon: _react2.default.createElement(_icon2.default, { category: 'standard', name: 'document', size: 'small' }),
						empty: isEmpty ? _react2.default.createElement(_empty2.default, { heading: 'No Related Items' }) : null
					},
					_react2.default.createElement(
						_dataTable2.default,
						{
						...
						_react2.default.createElement(
							...
							_react2.default.createElement(_highlightCell2.default, { search: this.state.filter })
						)
					)
				)
			);
		...
		handleFilterChange: function handleFilterChange(event) {
			...
			(0, _react3.action)('filter').apply(undefined, [event].concat(rest));
		...
		handleDeleteAllItems: function handleDeleteAllItems() {
			(0, _react3.action)('delete all').apply(undefined, arguments);
		...
		handleAddItem: function handleAddItem() {
			(0, _react3.action)('add').apply(undefined, arguments);

			this.setState({
				items: [{ name: (0, _lodash2.default)('New item #') }].concat(_toConsumableArray(this.state.items))
			});
		}
	});
	...
	(0, _react3.storiesOf)(_constants.CARD, module).addDecorator(function (getStory) {
		...
		return _react2.default.createElement(DemoCard, { items: sampleItems });
	}).add('Empty', function () {
		return _react2.default.createElement(DemoCard, { items: [] });
