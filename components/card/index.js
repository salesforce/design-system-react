define(['module', 'react', 'prop-types', 'classnames', './private/header', './private/body', './private/footer', './empty', '../../utilities/constants'], function (module, _react, _propTypes, _classnames, _header, _body, _footer, _empty, _constants) {
	'use strict';
