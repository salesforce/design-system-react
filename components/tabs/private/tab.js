define(['exports', 'react', 'prop-types', 'classnames', '../../../utilities/constants', 'react-dom'], function (exports, _react, _propTypes, _classnames, _constants, _reactDom) {
	'use strict';
    ...
    */
		...
		render: function render() {
			...
			var _props = this.props,
			    ...
			    attributes = _objectWithoutProperties(_props, ['selected', 'disabled', 'panelId', 'activeTabClassName', 'disabledTabClassName', 'className', 'children', 'id', 'variant']);
