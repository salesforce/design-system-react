define(['exports', 'react', 'prop-types', 'shortid', 'classnames', 'lodash.isfunction', 'lodash.isnumber', './private/tabs-list', './private/tab', './private/tab-panel', '../../utilities/constants', '../../utilities/key-code', '../../utilities/event'], function (exports, _react, _propTypes, _shortid, _classnames, _lodash, _lodash3, _tabsList, _tab3, _tabPanel, _constants, _keyCode, _event) {
	'use strict';
							...
							return _react2.default.createElement(
								_tab4.default,
								{
									...
									ref: function ref(node) {
										_this2.tabs[index] = { tab: child, node: node };
									},
									focus: focus,
									selected: selected,
									id: id,
