define(['module', 'react', 'react-dom', 'shortid', 'classnames', 'lodash.isfunction', 'lodash.isnumber', './private/tabs-list', './private/tab', './private/tab-panel', '../../utilities/constants', '../../utilities'], function (module, _react, _reactDom, _shortid, _classnames, _lodash, _lodash3, _tabsList, _tab3, _tabPanel, _constants, _utilities) {
	'use strict';
    ...
    */
		...
		render: function render() {
			...
			var _props = this.props,
			    ...
			    attributes = _objectWithoutProperties(_props, ['className', 'id', 'variant']);
