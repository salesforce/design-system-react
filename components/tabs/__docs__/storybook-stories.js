...
var getTabs = function getTabs() {
	return _react2.default.createElement(
		...
		_react2.default.createElement(
			_tabs2.default,
			{ id: 'main-tabs-demo', className: 'custom-class-is-custom', foo: 'baz' },
			_react2.default.createElement(
				_panel2.default,
				{ label: 'Tab 1' },
				_react2.default.createElement(
...
var getTabsScoped = function getTabsScoped() {
	return _react2.default.createElement(
		...
		_react2.default.createElement(
			_tabs2.default,
			{ id: 'scoped-tabs-demo', variant: 'scoped' },
			_react2.default.createElement(
				_panel2.default,
				{ label: 'Tab 1' },
				_react2.default.createElement(
	...
	render: function render() {
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				...
				this.state.showB && this.state.disableB ? _react2.default.createElement(
					_panel2.default,
				...
				) : this.state.showB && _react2.default.createElement(
					_panel2.default,
					{ label: 'Tab B' },
					_react2.default.createElement(
						'p',
				...
				this.state.showC && this.state.disableC ? _react2.default.createElement(
					_panel2.default,
					{ label: 'Tab C', disabled: true },
					_react2.default.createElement(
						'p',
						null,
						'This is tab C.'
					)
				) : this.state.showC && _react2.default.createElement(
					_panel2.default,
					{ label: 'Tab C' },
					_react2.default.createElement(
						'p',
   ...
   */
	...
	render: function render() {
		return _react2.default.createElement(
			...
			_react2.default.createElement(_button2.default, { id: 'show-state', label: 'Show State', onClick: this.showState }),
			_react2.default.createElement(_button2.default, { id: 'monday', label: 'Monday', onClick: this.handleButtonClicked }),
			...
			_react2.default.createElement(_button2.default, { id: 'friday', label: 'Friday', onClick: this.handleButtonClicked }),
			_react2.default.createElement(_button2.default, { id: 'none', label: 'None', onClick: this.handleButtonClicked }),
			_react2.default.createElement(_button2.default, {
				id: 'previous',
				label: 'Previous',
				onClick: this.handleButtonClicked
...
var getCustomContentTabs = function getCustomContentTabs() {
	var tab1Label = _react2.default.createElement(
		'div',
	...
	var tab2Label = _react2.default.createElement(
		'span',
		{ style: { color: 'red' } },
		'my other tab'
	);
...
var DemoTabsInterceptSelect = (0, _createReactClass2.default)({
	...
	handleTabSelect: function handleTabSelect(next, last) {
		...
		this.setState({ intercepts: intercepts });
		return false;
	},
	render: function render() {
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				...
				_react2.default.createElement(
					...
					this.state.intercepts > 0 && _react2.default.createElement(
						'p',
						null,
			...
			_react2.default.createElement(
				...
				_react2.default.createElement(
					...
					_react2.default.createElement(
						'p',
						null,
						'You should be able to reach this panel'
					)
				)
			)
		);
...
(0, _react3.storiesOf)(_constants.TABS, module).addDecorator(function (getStory) {
	...
	return _react2.default.createElement(DemoTabsOutsideControl, { className: 'controlled-yo' });
}).add('Conditional', function () {
	return _react2.default.createElement(DemoTabsConditional, { className: 'conditional-yo' });
