	...
	var AccordionPanel = function AccordionPanel(_ref) {
		...
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				'section',
				{ className: (0, _classnames2.default)('slds-accordion__section', { 'slds-is-open': expanded }) },
				_react2.default.createElement(
					'div',
				...
				_react2.default.createElement(
					'div',
					{ 'aria-hidden': !expanded, className: 'slds-accordion__content', id: id + '-accordion-panel' },
					children
				)
			)
		);
