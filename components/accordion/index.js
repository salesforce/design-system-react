define(['exports', 'react', 'prop-types', 'classnames', 'shortid', '../../utilities/constants'], function (exports, _react, _propTypes, _classnames, _shortid, _constants) {
	'use strict';
		...
		_createClass(Accordion, [{
			...
			value: function render() {
				return _react2.default.createElement(
					'ul',
					{ name: this.props.id || this.generatedId, className: (0, _classnames2.default)('slds-accordion', this.props.className) },
					this.props.children
				);
			}
		}]);
