...
var _baseWithOverflowMenu = _interopRequireDefault(require("../__examples__/base-with-overflow-menu"));
...
(0, _react2.storiesOf)(_constants.BREADCRUMB, module).addDecorator(function (getStory) {
  ...
  return _react.default.createElement(_baseWithOverflowMenu.default, null);
});