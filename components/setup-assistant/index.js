...
function (_React$Component) {
  ...
  function SetupAssistant() {
    ...
    return _possibleConstructorReturn(this, _getPrototypeOf(SetupAssistant).apply(this, arguments));
  }
  ...
  _createClass(SetupAssistant, [{
    ...
    value: function componentDidMount() {
      (0, _checkProps.default)(_constants.SETUP_ASSISTANT, this.props, _docs.default);
    }
  }, {
    ...
    value: function render() {
      ...
      var steps = _react.default.createElement("ol", {
        id: this.getId(),
        ...
        return _react.default.cloneElement(child, _objectSpread({
          index: i,
          onToggleIsOpen: _this.props.onStepToggleIsOpen,
          stepNumber: i + 1
        }, child.props));
      }));

      return this.props.isCard ? _react.default.createElement("section", {
        className: "slds-card"
      }, _react.default.createElement("header", {
        className: "slds-theme_shade slds-p-around_medium slds-m-bottom_small"
      }, this.props.progressBar), steps) : _react.default.createElement(_react.default.Fragment, null, steps);
    }
  }]);
