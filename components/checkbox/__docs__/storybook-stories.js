...
var _toggle = require("../__examples__/toggle");
...
Object.defineProperty(CheckboxIndeterminate, "displayName", {
  ...
  enumerable: true,
  writable: true,
  value: "".concat(_constants.CHECKBOX, "_INDETERMINATE")
});
(0, _react3.storiesOf)(_constants.CHECKBOX, module).addDecorator(function (getStory) {
  ...
  return _react2.default.createElement(_snapshotBase2.default, null);
}).add('Doc site Snapshot Toggle', function () {
  return _react2.default.createElement(_snapshotToggle2.default, null);
