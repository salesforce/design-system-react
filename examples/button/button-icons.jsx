...
<div className="-x-small-buttons--horizontal">
	...
	<div style={{backgroundColor: "#4BC076", padding: "10px", display: "inline-block"}} className="-m-horizontal--small">
		<Button
	...
	<div style={{backgroundColor: "#FFB75D", padding: "10px 50px", display: "inline-block"}} className="-hint-parent -m-horizontal--small">
		<Button
