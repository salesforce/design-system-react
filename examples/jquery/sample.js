...
},{"../landmark":8}],5:[function(require,module,exports){
(function (global, factory) {
	if (typeof define === 'function' && define.amd) {
...
(function (global, factory) {
	if (typeof define === 'function' && define.amd) {
		...
		factory(exports, require('./selectlist'), require('jquery'));
	} else {
		var mod = {
			exports: {}
		};
...
})(this, function (exports, _selectlist, _jquery) {
	'use strict';
	...
	(0, _$['default'])(function () {
		...
		(0, _$['default'])('#mySelectlist1').selectlist({
			resize: 'auto'
		});

		// sample method buttons
		(0, _$['default'])('.declarative .btnSelectlistGetSelectedItem').on('click', function () {
			console.log((0, _$['default'])('#mySelectlist1').selectlist('selectedItem'));
		});
		(0, _$['default'])('.declarative .btnSelectlistSelectByValue').on('click', function () {
			(0, _$['default'])('#mySelectlist1').selectlist('selectByValue', '2');
		});
		(0, _$['default'])('.declarative .btnSelectlistSelectBySelector').on('click', function () {
			(0, _$['default'])('#mySelectlist1').selectlist('selectBySelector', 'li[data-fizz=buzz]');
		});
		(0, _$['default'])('.declarative .btnSelectlistSelectByIndex').on('click', function () {
			(0, _$['default'])('#mySelectlist1').selectlist('selectByIndex', '4');
		});
		(0, _$['default'])('.declarative .btnSelectlistSelectByText').on('click', function () {
			(0, _$['default'])('#mySelectlist1').selectlist('selectByText', 'One');
		});
		(0, _$['default'])('.declarative .btnSelectlistEnableSelectlist').on('click', function () {
			(0, _$['default'])('#mySelectlist1').selectlist('enable');
		});
		(0, _$['default'])('.declarative .btnSelectlistDisableSelectlist').on('click', function () {
			(0, _$['default'])('#mySelectlist1').selectlist('disable');
		});
		(0, _$['default'])('.declarative .btnSelectlistDestroy').on('click', function () {
			var $container = (0, _$['default'])('#mySelectlist1').parent();
			var markup = (0, _$['default'])('#mySelectlist1').selectlist('destroy');
			console.log(markup);
		...
		// events
		(0, _$['default'])('#mySelectlist1').on('clicked.fu.selectlist', function (event, target) {
			console.log('clicked', target);
		});
		(0, _$['default'])('#mySelectlist1').on('changed.fu.selectlist', function (event, data) {
			console.log('changed', data);
		});

		(0, _$['default'])('#mySelectlist2').selectlist({
			dataSource: function dataSource(parentData, callback) {
				callback({
					data: [{ id: 0, name: 'tacos', type: 'mexican' }, { id: 1, name: 'burrito', type: 'mexican' }, { id: 2, name: 'tostada', type: 'mexican' }, { id: 3, name: 'hush puppies', type: 'southern' }]
				});
			},
			resize: 'auto'
		});
		...
		// sample method buttons
		(0, _$['default'])('.imperative .btnSelectlistGetSelectedItem').on('click', function () {
			console.log((0, _$['default'])('#mySelectlist2').selectlist('selectedItem'));
		});
		(0, _$['default'])('.imperative .btnSelectlistSelectByValue').on('click', function () {
			(0, _$['default'])('#mySelectlist2').selectlist('selectByValue', '2');
		});
		(0, _$['default'])('.imperative .btnSelectlistSelectBySelector').on('click', function () {
			(0, _$['default'])('#mySelectlist2').selectlist('selectBySelector', 'li[data-fizz=buzz]');
		});
		(0, _$['default'])('.imperative .btnSelectlistSelectByIndex').on('click', function () {
			(0, _$['default'])('#mySelectlist2').selectlist('selectByIndex', '4');
		});
		(0, _$['default'])('.imperative .btnSelectlistSelectByText').on('click', function () {
			(0, _$['default'])('#mySelectlist2').selectlist('selectByText', 'One');
		});
		(0, _$['default'])('.imperative .btnSelectlistEnableSelectlist').on('click', function () {
			(0, _$['default'])('#mySelectlist2').selectlist('enable');
		});
		(0, _$['default'])('.imperative .btnSelectlistDisableSelectlist').on('click', function () {
			(0, _$['default'])('#mySelectlist2').selectlist('disable');
		});
		(0, _$['default'])('.imperative .btnSelectlistDestroy').on('click', function () {
			var $container = (0, _$['default'])('#mySelectlist2').parent();
			var markup = (0, _$['default'])('#mySelectlist2').selectlist('destroy');
			console.log(markup);
			$container.append(markup);
			(0, _$['default'])('#mySelectlist2').selectlist();
		});
		...
		// events
		(0, _$['default'])('#mySelectlist2').on('clicked.fu.selectlist', function (event, target) {
			console.log('clicked', target);
		});
		(0, _$['default'])('#mySelectlist2').on('changed.fu.selectlist', function (event, data) {
			console.log('changed', data);
		});
	});
});

},{"./selectlist":7,"jquery":1}],7:[function(require,module,exports){
(function (global, factory) {
	if (typeof define === "function" && define.amd) {
		define(["exports", "../landmark", "../core/selectlist", "jquery"], factory);
	} else if (typeof exports !== "undefined") {
		factory(exports, require("../landmark"), require("../core/selectlist"), require("jquery"));
	} else {
		var mod = {
			exports: {}
		};
		factory(mod.exports, global.landmark, global.selectlist, global.$);
		global.selectlist = mod.exports;
	}
})(this, function (exports, _landmark, _coreSelectlist, _jquery) {
	"use strict";
	...
	var Selectlist = function Selectlist(element, options) {
		...
		this.options = _$["default"].extend({}, _$["default"].fn.selectlist.defaults, options);
		this._collection = [];

		if (_landmark.Landmark.isFunction(this.options.dataSource)) {
			this.populate();
		}
		...
		this.$element.on('click.fu.selectlist', '.dropdown-menu a', _$["default"].proxy(this.itemClicked, this));
		...
		if (items.length === 0) {
			this.disable();
			this.doSelect((0, _$["default"])(this.options.emptyLabelHTML));
		}
		...
		this.$element.on('shown.bs.dropdown', function () {
			...
			(0, _$["default"])(document).on('keypress.fu.selectlist', function (e) {

				// get the key that was pressed
				var key = String.fromCharCode(e.which);
				// look the items to find the first item with the first character match and set focus
				$this.find("li").each(function (idx, item) {
					if ((0, _$["default"])(item).text().charAt(0).toLowerCase() === key) {
						(0, _$["default"])(item).children('a').focus();
						return false;
					}
				});
			});
		...
		this.$element.on('hide.bs.dropdown', function () {
			(0, _$["default"])(document).off('keypress.fu.selectlist');
		});
	};

	Selectlist.prototype = _extends({}, _coreSelectlist.SelectlistCore, {
		...
		doSelect: function doSelect($item) {
			...
			this.$label.html((0, _$["default"])(this.$selectedItem.children()[0]).html());

			// clear and set selected item to allow declarative init state
			// unlike other controls, selectlist's value is stored internal, not in an input
			this.$element.find('li').each(function () {
				if ($selectedItem.is((0, _$["default"])(this))) {
					(0, _$["default"])(this).attr('data-selected', true);
				} else {
					(0, _$["default"])(this).removeData('selected').removeAttr('data-selected');
				}
			});
		},
		...
		itemClicked: function itemClicked(e) {
			...
			if ((0, _$["default"])(e.currentTarget).parent('li').is('.disabled, :disabled')) {
				return;
			}

			// is clicked element different from currently selected element?
			if (!(0, _$["default"])(e.target).parent().is(this.$selectedItem)) {
				this.itemChanged(e);
			}
		...
		itemChanged: function itemChanged(e) {
			...
			this.doSelect((0, _$["default"])(e.target).closest('li'));
		...
		populate: function populate() {
			...
			this.options.dataSource(selectlistData ? selectlistData : {}, function (items) {
				...
				var html = '<button class="btn btn-default dropdown-toggle" data-toggle="dropdown" type="button">' + '			<span class="selected-label">&nbsp;</span>' + '			<span class="caret"></span>' + '			<span class="sr-only">Toggle Dropdown</span>' + '		</button>' + '		<ul class="dropdown-menu" role="menu">' + '			<li data-value="1"><a href="#">One</a>' + '			</li>' + '			<li data-value="2"><a href="#">Two</a>' + '			</li>' + '			<li data-selected="true" data-value="3"><a href="#">Three</a>' + '			</li>' + '			<li data-value="4"><a href="#">Buzz</a>' + '			</li>' + '			<li data-value="Item Five" data-foo="bar" data-fizz="buzz"><a href="#">Item Five</a>' + '			</li>' + '			<li class="disabled" disabled="disabled" data-value="disabled"><a href="#">Disabled item</a>' + '			</li>' + '		</ul>' + '		<input class="hidden hidden-field" name="mySelectlist" readonly="readonly" aria-hidden="true" type="text" />';
		...
		resize: function resize() {
			var width = 0;
			var newWidth = 0;
			var sizer = (0, _$["default"])('<div/>').addClass('selectlist-sizer');

			if (Boolean((0, _$["default"])(document).find('html').hasClass('fuelux'))) {
				// default behavior for fuel ux setup. means fuelux was a class on the html tag
				(0, _$["default"])(document.body).append(sizer);
			} else {
				// fuelux is not a class on the html tag. So we'll look for the first one we find so the correct styles get applied to the sizer
				(0, _$["default"])('.fuelux:first').append(sizer);
			}

			sizer.append(this.$element.clone());

			this.$element.find('a').each(function () {
				sizer.find('.selected-label').text((0, _$["default"])(this).text());
		...
		selectedItem: function selectedItem() {
			...
			return _$["default"].extend({
				text: txt
			}, this.$selectedItem.data());
		},

		selectByText: function selectByText(text) {
			var $item = (0, _$["default"])([]);
			this.$element.find('li').each(function () {
				if ((this.textContent || this.innerText || (0, _$["default"])(this).text() || '').toLowerCase() === (text || '').toLowerCase()) {
					$item = (0, _$["default"])(this);
					return false;
				}
			});
			this.doSelect($item);
	...
	_$["default"].fn.selectlist = function (option) {
	...
	_$["default"].fn.selectlist.defaults = {
		emptyLabelHTML: '<li data-value=""><a href="#">No items</a></li>'
	};

	_$["default"].fn.selectlist.Constructor = Selectlist;

	_$["default"].fn.selectlist.noConflict = function () {
		_$["default"].fn.selectlist = old;
		return this;
	};

	// DATA-API

	(0, _$["default"])(document).on('mousedown.fu.selectlist.data-api', '[data-initialize=selectlist]', function (e) {
		var $control = (0, _$["default"])(e.target).closest('.selectlist');
	...
	(0, _$["default"])(function () {
		(0, _$["default"])('[data-initialize=selectlist]').each(function () {
			var $this = (0, _$["default"])(this);
...
},{"../core/selectlist":5,"../landmark":8,"jquery":1}],8:[function(require,module,exports){
(function (global, factory) {
	if (typeof define === 'function' && define.amd) {
