...
(function (global, factory) {
	...
	var collection = [];
	var options = {};
	var selectlist = (0, _$['default'])('#selectlist1').selectlist();
  ...
  - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - */
	...
	(0, _$['default'])('#btnSelectlistGetSelectedItem').on('click', function () {
		console.log((0, _$['default'])('#mySelectlist1').selectlist('selectedItem'));
	});
	(0, _$['default'])('#btnSelectlistSelectByValue').on('click', function () {
		(0, _$['default'])('#mySelectlist1').selectlist('selectByValue', '2');
	});
	(0, _$['default'])('#btnSelectlistSelectBySelector').on('click', function () {
		(0, _$['default'])('#mySelectlist1').selectlist('selectBySelector', 'li[data-fizz=buzz]');
	});
	(0, _$['default'])('#btnSelectlistSelectByIndex').on('click', function () {
		(0, _$['default'])('#mySelectlist1').selectlist('selectByIndex', '4');
	});
	(0, _$['default'])('#btnSelectlistSelectByText').on('click', function () {
		(0, _$['default'])('#mySelectlist1').selectlist('selectByText', 'One');
	});
	(0, _$['default'])('#btnSelectlistEnableSelectlist').on('click', function () {
		(0, _$['default'])('#mySelectlist1').selectlist('enable');
	});
	(0, _$['default'])('#btnSelectlistDisableSelectlist').on('click', function () {
		(0, _$['default'])('#mySelectlist1').selectlist('disable');
	});
	(0, _$['default'])('#btnSelectlistDestroy').on('click', function () {
